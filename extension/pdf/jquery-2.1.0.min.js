/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function (a, b) {
  ...
  (o.fn = o.prototype =
    ...
    o.extend({
      ...
      globalEval: function (a) {
        ...
        (a = o.trim(a)),
          a &&
            (1 === a.indexOf("use strict") ? ((b = m.createElement("script")), (b.text = a), m.head.appendChild(b).parentNode.removeChild(b)) : c(a));
      },
    ...
    o.extend({
      ...
      ready: function (a) {
        (a === !0 ? --o.readyWait : o.isReady) ||
          ((o.isReady = !0), (a !== !0 && --o.readyWait > 0) || (H.resolveWith(m, [o]), o.fn.trigger && o(m).trigger("ready").off("ready")));
      },
    });
  ...
  (o.ready.promise = function (b) {
    return (
      H ||
        ((H = o.Deferred()),
        "complete" === m.readyState ? setTimeout(o.ready) : (m.addEventListener("DOMContentLoaded", I, !1), a.addEventListener("load", I, !1))),
      H.promise(b)
    );
  }),
    o.ready.promise();
  ...
  o.extend({
    ...
    o.extend({
      queue: function (a, b, c) {
        var d;
        return a
          ? ((b = (b || "fx") + "queue"), (d = L.get(a, b)), c && (!d || o.isArray(c) ? (d = L.access(a, b, o.makeArray(c))) : d.push(c)), d || [])
          : void 0;
      },
        ...
        return (
          ...
          e ||
            ...
            (k &&
              o.isFunction(d[q]) &&
              !o.isWindow(d) &&
              ((h = d[k]), h && (d[k] = null), (o.event.triggered = q), d[q](), (o.event.triggered = void 0), h && (d[k] = h))),
          b.result
        );
      }
    },
    ...
    ajax: function (a, b) {
      ...
      function x(a, b, f, h) {
        ...
        2 !== t &&
          ...
          j
            ? (k.ifModified &&
                ((w = v.getResponseHeader("Last-Modified")), w && (o.lastModified[d] = w), (w = v.getResponseHeader("etag")), w && (o.etag[d] = w)),
              204 === a || "HEAD" === k.type
                ? (x = "nocontent")
                : 304 === a
                ? (x = "notmodified")
