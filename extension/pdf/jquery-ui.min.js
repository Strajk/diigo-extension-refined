...
(function (e, t) {
  function i(t, i) {
    ...
    return "area" === r
      ? ((s = t.parentNode),
        (a = s.name),
        t.href && a && "map" === s.nodeName.toLowerCase() ? ((o = e("img[usemap=#" + a + "]")[0]), !!o && n(o)) : !1)
        ...
        for (n in a[r])
          (o = a[r][n]),
            a[r].hasOwnProperty(n) &&
              o !== e &&
              (i[n] = t.isPlainObject(o) ? (t.isPlainObject(i[n]) ? t.widget.extend({}, i[n], o) : t.widget.extend({}, o)) : o);
      return i;
    }),
      ...
      flip: {
        ...
        top: function (t, e) {
          ...
          0 > c
            ...
            : u > 0 &&
              ((i = t.top - e.collisionPosition.marginTop + p + f + g - l), t.top + p + f + g > u && (i > 0 || u > r(i)) && (t.top += p + f + g));
        },
      },
      flipfit: {
        left: function () {
                ...
                e.hide().animate(a, {
                  ...
                  step: function (e, i) {
                    (i.now = Math.round(e)),
                      "height" !== i.prop
                        ? (d += i.now)
                        : "content" !== h.options.heightStyle && ((i.now = Math.round(n - t.outerHeight() - d)), (d = 0));
                  },
                }),
                undefined)
              : t.animate(i, o, r, v)
      ...
      __response: function (e) {
        ...
        this._superApply(arguments),
          this.options.disabled ||
            this.cancelSearch ||
            ((t = e && e.length ? this.options.messages.results(e.length) : this.options.messages.noResults), this.liveRegion.text(t));
      },
    });
})(jQuery);
(function (e) {
  ...
  e.widget("ui.button", {
        ...
        "checkbox" === this.type
          ...
          : (this.buttonElement
              ...
              .bind("keydown" + this.eventNamespace, function (t) {
                return o.disabled
                  ? !1
                  : ((t.keyCode === e.ui.keyCode.SPACE || t.keyCode === e.ui.keyCode.ENTER) && e(this).addClass("ui-state-active"), undefined);
              })
    ...
    _setOption: function (e, t) {
      return (
        this._super(e, t),
        "disabled" === e
          ? (this.element.prop("disabled", !!t), t && this.buttonElement.removeClass("ui-state-focus"), undefined)
  ...
  e.extend(i.prototype, {
    ...
    _adjustDate: function (t, i, a) {
      ...
      this._isDisabledDatepicker(s[0]) ||
        (this._adjustInstDate(n, i + ("M" === a ? this._get(n, "showCurrentAtPos") : 0), a), this._updateDatepicker(n));
    },
    ...
    _selectDate: function (t, i) {
      ...
      (i = null != i ? i : this._formatDate(n)),
        ...
        n.inline
          ...
          : (this._hideDatepicker(), (this._lastInput = n.input[0]), "object" != typeof n.input[0] && n.input.focus(), (this._lastInput = null));
    },
    ...
    _generateHTML: function (e) {
      ...
      if ((0 > Z && ((Z += 12), et--), X))
        for (
          t = this._daylightSavingAdjust(new Date(X.getFullYear(), X.getMonth() - q[0] * q[1] + 1, X.getDate())), t = $ && $ > t ? $ : t;
    ...
    _generateMonthYearHeader: function (e, t, i, a, s, n, r, o) {
      ...
      if (n || !f) y += "<span class='ui-datepicker-month'>" + r[t] + "</span>";
        ...
        for (
          ...
          (!u || h >= a.getMonth()) &&
            (!c || s.getMonth() >= h) &&
            (y += "<option value='" + h + "'" + (h === t ? " selected='selected'" : "") + ">" + o[h] + "</option>");
        y += "</select>";
      }
            ...
            return (
              ...
              f(a.props, function (t, n) {
                ...
                null !== h &&
                  (null === o
                    ? (l[a] = h)
                    : (c.mod && (h - o > c.mod / 2 ? (o += c.mod) : o - h > c.mod / 2 && (o -= c.mod)), (l[a] = i((h - o) * e + o, n))));
              }),
              this[n](l)
            );
          },
                ...
                (h.fn[e] = function (n) {
                  ...
                  return "undefined" === o
                    ...
                    : ("function" === o && ((n = n.call(this, c)), (o = t.type(n))),
                      null == n && i.empty
                        ? this
                        : ("string" === o && ((a = r.exec(n)), a && (n = c + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1))),
                          (h[i.idx] = n),
                          this[l](h)));
                });
            });
  ...
  (t.effects.effect.puff = function (e, i) {
    ...
    (t.effects.effect.size = function (e, i) {
      ...
      "show" === p && o.show(),
        ...
        ("box" === g || "both" === g) &&
          (a.from.y !== a.to.y &&
            ((_ = _.concat(u)), (o.from = t.effects.setTransition(o, u, a.from.y, o.from)), (o.to = t.effects.setTransition(o, u, a.to.y, o.to))),
          a.from.x !== a.to.x &&
            ((_ = _.concat(d)), (o.from = t.effects.setTransition(o, d, a.from.x, o.from)), (o.to = t.effects.setTransition(o, d, a.to.x, o.to)))),
        ("content" === g || "both" === g) &&
          a.from.y !== a.to.y &&
        ...
        ("content" === g || "both" === g) &&
          ...
          o.find("*[width]").each(function () {
            ...
            f && t.effects.save(i, h),
              ...
              a.from.y !== a.to.y &&
                ((i.from = t.effects.setTransition(i, u, a.from.y, i.from)), (i.to = t.effects.setTransition(i, u, a.to.y, i.to))),
              a.from.x !== a.to.x &&
                ((i.from = t.effects.setTransition(i, d, a.from.x, i.from)), (i.to = t.effects.setTransition(i, d, a.to.x, i.to))),
              i.css(i.from),
  ...
  t.widget("ui.resizable", t.ui.mouse, {
    ...
    _create: function () {
      ...
      if (
        ...
        for (
          "all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), e = this.handles.split(","), this.handles = {}, i = 0;
          e.length > i;
          i++
        )
          (s = t.trim(e[i])),
      ...
      resize: function (e) {
        ...
        d[0] !== document && /static/.test(d.css("position")) && (u = h),
          ...
          s + o.size.height >= o.parentData.height &&
            ((o.size.height = o.parentData.height - s), c && (o.size.width = o.size.height * o.aspectRatio));
      },
      stop: function () {
          ...
          this.selectees.each(function () {
            ...
            i &&
              ...
              ("touch" === n.tolerance
                ...
                : "fit" === n.tolerance && (h = i.left > a && r > i.right && i.top > o && l > i.bottom),
              h
...
(function (t) {
  ...
  t.widget("ui.slider", t.ui.mouse, {
    ...
    _start: function (t, e) {
      ...
      return (
        this.options.values && this.options.values.length && ((i.value = this.values(e)), (i.values = this.values())), this._trigger("start", t, i)
      );
    },
      ...
      keydown: function (i) {
        ...
        switch (i.keyCode) {
          ...
          case t.ui.keyCode.LEFT:
            if (
              (i.preventDefault(),
              !this._keySliding && ((this._keySliding = !0), t(i.target).addClass("ui-state-active"), (s = this._start(i, r)), s === !1))
            )
              return;
        }
    ...
    _mouseStop: function (e, i) {
      if (e) {
        if ((t.ui.ddmanager && !this.options.dropBehaviour && t.ui.ddmanager.drop(this, e), this.options.revert)) {
          ...
          (o && "x" !== o) ||
            (a.left =
              n.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollLeft)),
            (o && "y" !== o) ||
              (a.top =
                n.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === document.body ? 0 : this.offsetParent[0].scrollTop)),
            (this.reverting = !0),
