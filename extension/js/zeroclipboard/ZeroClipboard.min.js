...
!(function (a, b) {
  ...
  var c,
    ...
    A = function () {
      ...
      for (a = 1, c = h.length; c > a; a++)
        if (null != (d = h[a])) for (e in d) w.call(d, e) && ((f = i[e]), (g = d[e]), i !== g && g !== b && (i[e] = g));
      return i;
    },
    B = function (a) {
      var b, c, d, e;
    ...
    H = function (a) {
      ...
      return (
        "string" == typeof a &&
          ...
          c && c[1] ? (b = c[1]) : ((c = a.match(/\)@((?:http[s]?|file):\/\/[\/]?.+?\/[^:\)]*?)(?::\d+)(?::\d+)?/)), c && c[1] && (b = c[1]))),
        b
      );
    },
    I = function () {
      ...
      return (
        ...
        a && !vb(a)
          ? "ready" === a.type && N.overdue === !0
            ...
            : ((b = A({}, a)), tb.call(this, b), "copy" === a.type && ((d = Db(Q)), (c = d.data), (R = d.formatMap)), c)
          : void 0
      );
    },
    fb = function () {
    ...
    ob = function (a) {
      ...
      if (("string" == typeof a && a ? ((b = a), (a = {})) : "object" == typeof a && a && "string" == typeof a.type && a.type && (b = a.type), b)) {
        ...
        var c = U[a.type];
        return (
          "error" === a.type && a.name && c && (c = c[a.name]),
          c && (a.message = c),
          "ready" === a.type &&
            A(a, {
              target: null,
      ...
      switch ((delete a._source, a.type)) {
        ...
        case "copy":
          ...
          !Q["text/html"] && !Q["text/plain"] && k && (j = k.value || k.outerHTML || k.innerHTML) && (i = k.value || k.textContent || k.innerText)
            ...
            : !Q["text/plain"] &&
              a.target &&
              (i = a.target.getAttribute("data-clipboard-text")) &&
              (a.clipboardData.clearData(), a.clipboardData.setData("text/plain", i));
          break;
        case "aftercopy":
    ...
    xb = function (a) {
      if (a && "string" == typeof a.type && a) {
        ...
        c &&
          ...
          b.initMouseEvent && (b.initMouseEvent.apply(b, h), (b._source = "js"), c.dispatchEvent(b)));
      }
    },
    yb = function () {
    ...
    Cb = function () {
      ...
      if (a) {
        var d = Ab(a);
        d &&
          ("activex" === N.pluginType && "readyState" in a
    ...
    Gb = function (a) {
      ...
      if (
        (a.trustedDomains &&
          ("string" == typeof a.trustedDomains
            ? (e = [a.trustedDomains])
            : "object" == typeof a.trustedDomains && "length" in a.trustedDomains && (e = a.trustedDomains)),
        e && e.length)
      )
      ...
      return (
        h.length && (g += "trustedOrigins=" + n(h.join(","))),
    ...
    Kb = function (a, b) {
      ...
      if (("string" == typeof b && b && (f = b.split(/\s+/)), a && 1 === a.nodeType && f.length > 0))
        if (a.classList) for (c = 0, d = f.length; d > c; c++) a.classList.add(f[c]);
    ...
    Lb = function (a, b) {
      var c,
        ...
        f = [];
      if (("string" == typeof b && b && (f = b.split(/\s+/)), a && 1 === a.nodeType && f.length > 0))
        if (a.classList && a.classList.length > 0) for (c = 0, d = f.length; d > c; c++) a.classList.remove(f[c]);
        else if (a.className) {
    ...
    Ob = function (a) {
      ...
      var b = m(a, null),
        ...
        i =
          ...
          (g || (!!h && (c || h.height > 0) && (d || h.width > 0) && (e || h.top >= 0) && (f || h.left >= 0)));
      return i;
    },
    Pb = function () {
      j(S), (S = 0), l(T), (T = 0);
    ...
    Tb = function (b) {
      ...
      if (((b = b === !0), M === !1)) g = !1;
        ...
        if (d && 1 === d.nodeType && "IFRAME" === d.nodeName)
          ...
          (null === c || (e && "SecurityError" === e.name && /(^|[\s\(\[@])sandbox(es|ed|ing|[\s\.,!\)\]@]|$)/.test(e.message.toLowerCase()))) &&
            (g = !0);
        }
      }
  ...
  v(Vb, "version", {
    ...
    (Vb.focus = Vb.activate =
      function () {
        return kb.apply(this, z(arguments));
      }),
    (Vb.blur = Vb.deactivate =
      function () {
    ...
    ec = function (a) {
      ...
      for (var b = 0; b < a.length; b++)
        if (w.call(a, b) && a[b] && 1 === a[b].nodeType) {
          a[b].zcClippingId
            ? -1 === Zb[a[b].zcClippingId].indexOf(this.id) && Zb[a[b].zcClippingId].push(this.id)
            : ((a[b].zcClippingId = "zcClippingId_" + Yb++), (Zb[a[b].zcClippingId] = [this.id]), Z.autoActivate === !0 && lc(a[b]));
