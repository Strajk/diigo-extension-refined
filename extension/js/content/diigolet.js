window.diigolet == undefined &&
  (function () {
    ...
    function Db(a) {
      a = a.concat();
      for (var c = 0; c < a.length; ++c) for (var d = c + 1; d < a.length; ++d) JSON.stringify(a[c]) === JSON.stringify(a[d]) && a.splice(d--, 1);
      return a;
    }

    function db(a) {
      a = a.concat();
      for (var c = 0; c < a.length; ++c) for (var d = c + 1; d < a.length; ++d) a[c] === a[d] && a.splice(d--, 1);
      return a;
    }
    ...
    function I() {
      ...
      if (x.logLevel != "never")
        try {
          ...
          c > -1 && d > -1 && c >= d && window.console && console.log.apply(console, a);
        } catch (f) {}
    }
    ...
    function W() {
      for (var a = [].slice.call(arguments), c = a.shift(), d = 0, f = a.length, h; (h = a[d]), d < f; d++) for (var i in h) c[i] = h[i];
      return c;
    }
    ...
    function M(a, c, d) {
      if (a.length !== undefined) for (var f = 0, h = a.length; f < h; f++) c.call(d, a[f], f);
      else for (f in a) c.call(d, a[f], f);
    }

    function eb(a, c, d) {
      for (var f = [], h = 0, i = a.length; h < i; h++) c.call(d, a[h], h) && f.push(a[h]);
      return f;
    }

    function pa(a, c, d) {
      for (var f = a.length, h = Array(f), i = 0; i < f; i++) h[i] = c.call(d, a[i], i);
      return h;
    }

    function Fb(a, c, d) {
      for (var f = 0, h = a.length; f < h; f++) if (c.call(d, a[f], f)) return true;
      return false;
    }
    ...
    function Ia(a, c, d) {
      ...
      d = d;
      for (var h = a.length, i; (i = a[d]), d < h; d++) if (f ? c(i) : i == c) return d;
      return -1;
    }
    ...
    function $b(a) {
      for (var c = Array(a.length), d = a.length - 1, f = 0; d >= 0; d--, f++) c[f] = a[d];
      return c;
    }
    ...
    function Ja(a) {
      function c(u, s) {
        ...
        return w | y ? (F & 1073741824 ? F ^ 3221225472 ^ B ^ C : F ^ 1073741824 ^ B ^ C) : F ^ B ^ C;
      }
      ...
      m = (function (u) {
        var s,
          w = u.length;
        s = w + 8;
        for (var y = ((s - (s % 64)) / 64 + 1) * 16, B = Array(y - 1), C = 0, F = 0; F < w; ) {
          s = (F - (F % 4)) / 4;
          C = (F % 4) * 8;
    ...
    function rb() {
      ...
      sb.mousedown(function (a) {
        if (a.target.tagName == "INPUT" || a.target.tagName == "TEXTAREA") tb = true;
        else if (
    ...
    function ub(a) {
      ...
      else if (a == "signIn") c = x.urls.getSignInURL() + "?referInfo=" + encodeURIComponent("/images/diigo-logo.png#SIGNED_IN");
    ...
    function Mb() {
      ...
      for (var c = k.myTagsWithCount.length, d = 0; d < c; d++) a[d] = k.myTagsWithCount[d].name;
      a = {
    ...
    function dc(a) {
      ...
      da.clickedOn = U.clickedOn = gc.clickedOn = H.clickedOn = J.clickedOn = Ra = tb = false;
    }
      ...
      for (var c = "", d, f, h = /([^{}@]*)({[^{}]*})/g; (d = h.exec(qb)); ) {
        ...
        c +=
          $.map(f.split(","), function (i) {
            if (/(^|\s)body([\s.\[#]|$)/.test(i)) return i.replace("body", "body#" + a);
            if (/(^|\s)html(\s|$)/.test(i)) return i.replace("html", "html body#" + a);
    ...
    function Ma(a, c) {
      var d = gb(a),
        f = d.path;
      if (!/^https?$/i.test(d.protocol) && !/^ftp?$/i.test(d.protocol)) return false;
      if (/\.?diigo\./i.test(d.host))
        if (/^\/annotated\//i.test(f)) return false;
        else if (/(player|slides?)\.diigo\./i.test(d.host) && /^\/(list|feed)/i.test(f)) return false;
    ...
    function Sb() {
      ...
      return a.substring(a.length - 4) == ".pdf" && $('embed[type="application/pdf"]').length > 0 ? true : false;
    }
    ...
    var E = {
        dump: function () {
          window.diigolet.debug && window.console && console.log.apply(console, [].slice.call(arguments));
        },
        fork: function (a) {
          setTimeout(function () {
            a();
    ...
    E.lang = {
      isArray: function (a) {
        if (a) return this.isNumber(a.length) && this.isFunction(a.splice) && !this.hasOwnProperty(a.length);
        return false;
      },
      ...
      extendFiltered: function () {
        for (var a = [].slice.call(arguments), c = a.shift(), d = a.pop(), f = 0, h = a.length, i; (i = a[f]), f < h; f++)
          for (var l in i) {
            var m = d(l);
    ...
    E.string = {
      ...
      toQueryString: function (a) {
        var c = function (f, h) {
            ...
            h === undefined ? d.push(f) : d.push(f + "=" + (h == null ? "" : encodeURIComponent(h)));
          },
          d = [];
    ...
    E = {
      parseColor: function (a) {
        ...
        return c[a]
          ...
          : (result = /^rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)$/.exec(a))
          ? {
              r: parseInt(result[1]),
              g: parseInt(result[2]),
              b: parseInt(result[3]),
            }
          : (result = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)$/.exec(a))
          ? {
    ...
    var wb = {
      mixin: function (a) {
        Ya(a, this, Va("addEventListener removeEventListener fireEvent _resetEvents"));
        a._resetEvents();
      },
      ...
      fireEvent: function (a, c) {
        if (!this._supressEvents) {
          I("[event]", a);
          var d = this._events[a];
          if (d) for (var f = 0, h, i = d.length; (h = d[f]), f < i; f++) (typeof h == "function" ? h : h["on" + a]).apply(h, c);
        }
      },
    };
    ...
    Ta.URLParser.prototype._parse = function (a) {
      ...
      for (var c in this._fields) if (typeof a[this._fields[c]] != "undefined") this._values[c] = a[this._fields[c]];
    };
      ...
      var h = f.constructor,
        i = (f.constructor = function () {
          if (!ja._prototyping)
            ...
            } else if (arguments[0] != null) return (arguments[0].extend || d).call(arguments[0], f);
        });
      i.ancestor = this;
    ...
    ja.prototype = {
      extend: function (a, c) {
        if (arguments.length > 1) {
          var d = this[a];
          if (d && typeof c == "function" && (!d.valueOf || d.valueOf() != c.valueOf()) && /\bbase\b/.test(c)) {
            var f = c.valueOf();
            c = function () {
          ...
          if (!ja._prototyping && typeof this != "function") h = this.extend || h;
          for (
            var i = {
                toSource: null,
              },
    ...
    ja = ja.extend(
      ...
      },
      {
        ...
        forEach: function (a, c, d) {
          for (var f in a) this.prototype[f] === undefined && c.call(d, a[f], f, a);
        },
        implement: function () {
          for (var a = 0; a < arguments.length; a++)
            typeof arguments[a] == "function" ? arguments[a](this.prototype) : this.prototype.extend(arguments[a]);
          return this;
        },
        toString: function () {
    ...
    var Nb = function (a, c) {
        ...
        function i(n) {
          ...
          if (!(n < 0)) {
            ...
            if (o.mode == "multiple") {
              n = A.val();
              var s = d(n);
              new_value = s[0] >= 1 ? n.substr(0, s[0] + 1) + u + s[1] : u + " ";
            } else new_value = u;
            A.val(new_value);
            A.trigger("input");
            r.hide();
        ...
        function m(n) {
          ...
          for (var w = 0, y; (y = o.data[w]), w < o.data.length; w++)
            ...
            else y.toLowerCase().indexOf(n) != 0 && y.toLowerCase().indexOf(n) != -1 && s.push(y);
          s.sort(function (B, C) {
        ...
        function t(n, u) {
          if (u && u.length > 0) {
            ...
            var s = (function (w) {
              for (var y = w.offsetLeft || 0, B = w.offsetTop || 0; (w = w.offsetParent); ) {
                y += w.offsetLeft;
                B += w.offsetTop;
              }
              if ($.browser.opera && document.compatMode != "CSS1Compat") B += 30;
              return {
                x: y + 0,
                y: B + 0,
              };
        ...
        if (typeof o.multipleSeparator == "string") o.multipleSeparator = o.multipleSeparator.split("");
        this.destroy = function () {
          A.unbind("keydown", h).unbind("blur", D);
          $(window).unbind("scroll", f);
          A[0].autoCompleter = null;
        };
        A.attr("autocomplete", "off").addClass(o.inputClass).bind("keydown", h).bind("blur", D);
      ...
      Da = 'Please <a href="#" title="Sign in into Diigo.com" id="signIn">sign in</a> first.',
      ia = 0,
      Wa = 1,
      fa = 2;
    ...
    x.urls = {
      ...
      getGroupURL: function (a) {
        return a ? "https://groups.diigo.com/groups/" + a : "https://groups.diigo.com";
      },
      ...
      getFeedbackURL: function () {
        return "http://www.diigo.com/common/feedback";
      },
      getFollowOnTwitterURL: function () {
        return "http://www.twitter.com/diigo";
      },
    ...
    x.handlers = {
      ...
      overHighlight: function () {
        if (!k.isHighlightPen) {
          ...
          $("#diigolet-button-highlight-dropdown").toggleClass(k.mouseClass, true);
        }
      },
      outHighlight: function () {
        if (!k.isHighlightPen) {
          $("#diigolet-button-highlight").toggleClass(k.mouseClass, false);
          $("#diigolet-button-highlight-dropdown").toggleClass(k.mouseClass, false);
        }
      },
      dropDownColorMenu: function () {
        ...
        k.penColor && k.penColor.length > 0
          ? Q("diigolet-colorMenu-" + k.penColor).toggleClass("colorchecked", true)
      ...
      highlight: function (a, c, d) {
        if (qa()) {
          ...
          if (typeof k.permissions.annPermission !== "undefined" && !k.permissions.annPermission.annotationPermission) {
            ca.init();
            ca.show("highlight");
          }
          return f;
    ...
    var k = {
      ...
      resetData: function (a) {
        ...
        if (window.diigo_bookmark_url) this.bookmark.url = window.diigo_bookmark_url;
      },
      reset: function (a) {
        this.resetData(a);
      },
      paintAllAnnotations: function () {
            ...
            $(".id_" + f.id).on("dragstart", function (h) {
              ...
              $(".id_" + f.id).each(function () {
                if ($(this).hasClass("diigoHighlight")) {
                  ...
                  if ($(this).parent()[0].tagName == "A") l = '<a href="' + $(this).parent().attr("href") + '">' + l + "</a>";
                  i += l + " ";
                }
              });
        ...
        for (var a = $(".diigoHighlight"), c = [], d = 0; d < a.length; d++) c[d] = a[d].className.match(/id(\w)+/g)[0];
        a = db(c);
    ...
    var ic = {
      ...
      gc = {
        ...
        show: function (a, c) {
          if (k.signedIn) {
            if (k.launchMode.threeDForum && c == "selection") c = "selection_3df";
            var d = this.ele;
            this.shown = true;
            d.find(">div").css({
              display: "none",
            ...
            if (f && f.comments.length == 0) d.find("a._del")[f.user == k.user ? "show" : "hide"]();
            d.css({
              left: a.pageX + 3,
              top: a.pageY + 3,
            }).show();
    ...
    x.run = function (a, c) {
      ...
      if (k.generated == false) {
        ...
        } else a.shouldLoadBookmarkByMyself && k.signedIn && z.loadBookmark("showbar");
      } else {
        k.unpaintAllAnnotations();
    ...
    x.chromeRun = function (a, c) {
      ...
      if (
        (function () {
          ...
          return f.substring(f.length - 4) == ".pdf" && $('embed[type="application/pdf"]').length > 0 ? true : false;
        })()
      )
    ...
    var Fa = {
      ...
      Aa = {
        getDocumentSource: function () {
          ...
          a = a.documentElement;
          a = a.outerHTML ? a.outerHTML : XMLSerializer ? new XMLSerializer().serializeToString(a) : "<html>" + document.innerHTML + "</html>";
          return d + a;
        },
        removeDiigoStuffFromHtml: function (a) {
          a = a.replace(/<style[^<>]*id="diigolet-chrome-css"(?:.|\s)*?<\/style>/, "");
      ...
      Vb = {
        ...
        uploadDidSucceed: function (a) {
          (a = a.visit_url)
            ? L.notifyOK("Upload succeeded! <a href=" + a + ' target="_blank">check it out</a>')
            : L.notifyOK(chrome.i18n.getMessage("upload_success"));
        },
      },
      Ub = {
          ...
          $("script[src*=opentracker]").length &&
            window.addEventListener(
              ...
              function (a) {
                ...
                a.is("[href*=javascript:void]") && a.parents(".diigolet").length && a.attr("href", "javascript:void('ot_evt(')");
              },
              true
            );
        },
    ...
    $(document).ready(function () {
      ...
      $("#screenshot").click(function () {
        k.permissions.pdfPermission.pdfPermission ? ka.initSelectedCapture() : diigoModal.show("upgrade");
      });
      $("#text-screenshot").click(function () {
        ka.initSelectedCapture();
      });
      $('<div id="diigo-chrome-installed"></div>').appendTo(document.body).hide();
    ...
    var Wb = {
      ...
      parseTags: function (a, c) {
        ...
        for (var f = [], h = [], i = false, l = 0, m = a.length, t; (t = a.charAt(l)), l < m; l++)
          if (t == '"')
            if (i) {
              i = false;
              d();
    ...
    var N = ja.extend({
      ...
      getPageOffset: function () {
        ...
        a =
          this.type == ia
            ...
            : $("." + S.HIGHLIGHT_TYPE_CLASS + this.type + "." + S.HIGHLIGHT_ID_CLASS + this.id);
        if (a.size() <= 0)
          return {
            left: 0,
            top: 0,
        ...
        a.parents("div").filter(function () {
          if (c.getComputedStyle(this, null).getPropertyValue("position") == "relative") {
      ...
      jumpHere: function (a, c) {
        ...
        if (this.paintedSuccessfully) {
          var d = this.type == ia ? $("em." + ha.HIGHLIGHT_ID_CLASS + this.id) : this.getEle();
          if (d.size() == 0) k.notify("No corresponding text is found on the page. This page has probably been changed since you highlighted it.");
          else {
            if (a) {
              var f = d.eq(0).offset();
            ...
            e = {
              pageX: f.left,
              pageY: f.top + d.height() + 15,
            };
            H.hide();
            if (c || this.comments.length > 0) H.show(e, this, c ? "add" : "view", 400);
          }
        } else k.notify("No corresponding text is found on the page. This page has probably been changed since you highlighted it.");
      },
      activate: function () {},
    });
    W(N, {
      add: function (a, c, d, f) {
        ...
        if (!a.saved) {
          if (!a.id) {
            ...
            a.id = d == "video" ? Ja(a.content) : Ja(a.content + a.user + k.bookmark.urlId + a.nth);
          }
          a.extra.nth = a.nth;
          ...
          $("." + i).on("dragstart", function (l) {
            ...
            $("." + i).each(function () {
              if ($(this).hasClass("diigoHighlight")) {
                ...
                if ($(this).parent()[0].tagName == "A") t = '<a href="' + $(this).parent().attr("href") + '"">' + t + "</a>";
                m += t + " ";
              }
            });
      ...
      sort: function () {
        k.annotations.sort(function (a, c) {
          ...
          return a.extra.top - c.extra.top > 0 ? 1 : a.extra.top - c.extra.top == 0 ? a.extra.left - c.extra.left : -1;
        });
      },
    });
    var bb = N.extend({
    ...
    var ta = N.extend({
      constructor: function (a) {
        ...
        if (!this.content)
          ...
          else throw "Must specify either content or _focusedNode for image highlight";
        if (!this.extra.imageUrl) this.extra.imageUrl = ta.makeAbsUrl((this.content.match(/<img.*?\s+src=['"]?(.*?)['"]?[\s>]/im) || [])[1] || "", a);
      ...
      getEle: function () {
        ...
        if (a.size() == 0)
          for (
            ...
            if (m.src.indexOf(c) > -1 && d == ta.makeAbsUrl(m.src, k.bookmark.url)) {
              h++;
      ...
      paint: function (a) {
        ...
        if (d) {
          ...
          d.addClass(ha.HIGHLIGHT_CLASS)
            ...
            .addClass(a.extra.color && a.extra.color.length > 0 ? a.extra.color : "yellow")
            .toggleClass("diigoHighlightcommented", f.length > 0);
          if (d.size() > 0) {
            var h = d.offset();
            a.extra.top = h.top;
          ...
          if ($("div." + S.HIGHLIGHT_ID_CLASS + a.id).size() <= 0 && d.size() > 0) {
    ...
    var vb = N.extend({
      constructor: function (a) {
        ...
        this.base(a);
        this.saving = false;
        if (!this.id) this.id = Ja(Math.random() + Math.random() + new Date().getTime().toString());
        this.type = fa;
      },
      fixExtra: function () {
        var a =
    ...
    W(vb, {
      paint: function (a) {
        ...
        if (a.painted) {
          var c = a.getEle();
          if (c) {
            c.removeClass("diigoadd yellow blue green pink").addClass(a.extra.color);
            var d = H.getCommentsInfo(a.comments);
            d == "onlyPrivate" || d == "noComment" ? c.removeClass("group").addClass("private") : c.removeClass("private").addClass("group");
            setTimeout(function () {
              (H.getCommentCount("group", a.comments) || "") > 0 && c.find("span").text(H.getCommentCount("group", a.comments)).show();
            }, 100);
          }
        } else {
          c = $(mb)
          ...
          if (x.stickyNoteByContextMenu == true) {
            c.css({
              left: x.rightClickPos.x,
              top: x.rightClickPos.y,
            });
          ...
          d == "onlyPrivate" || d == "noComment" ? c.addClass("private") : c.addClass("group");
    ...
    var cb = ja.extend({
        constructor: function (a) {
          ...
          if (this.onlyInGroup && !(this.id > 0)) this.id = Math.random().toString().substr(2);
        },
        del: function (a) {
        ...
        addGroups: function (a) {
          ...
          M(a, function (d) {
            if (
              ...
              c.groups.push(d);
              k.fireEvent((c instanceof ya ? "pc" : "ic") + "_add", [c, d.name]);
            }
          });
        },
      }),
    ...
    W(ya, {
      add: function (a) {
        ...
        if (!a.saved) throw "[PageComment] add: adding an unsaved comment is probably and error";
      ...
      del: function (a, c) {
        ...
        a.onlyInGroup && a.groups.length == 0 && k.pageComments.splice(k.pageComments.indexOf(a), 1);
        return a;
      },
      find: function (a) {
        a = a.id || a;
    ...
    var va = cb.extend({
      constructor: function (a) {
        ...
        this.base(a);
        if (!this.annotationId) throw "[InlineComment ctr] must specify annotationId";
      },
    ...
    var z = {
        ...
        callback: function (a, c, d, f) {
          ...
          if (a) {
            ...
            a.code == 1 && this["cb_" + i + "_success"] && this["cb_" + i + "_success"](a.result, f);
            a.code == 0 && this["cb_" + i + "_failure"] && this["cb_" + i + "_failure"](a.result, a.status, f);
          }
          if ((c == 0 || c == 500) && this["cb_" + d + "_failure"]) this["cb_" + d + "_failure"](c, f);
          ...
          x.Messenger.send(
            {
              ...
              details: {
                ...
                data: c,
                transId: h,
                isInGroup: /group.diigo.(.*)\/item\/pdf/.test(window.location.href),
              },
            },
            function (l) {
        ...
        cb_list_create_failure: function (a) {
          ...
          $("#diigosc-savepopup").length > 0 && $("#diigosc-list-addBtn").removeClass("processing");
          chrome.runtime.sendMessage({
            name: "listCreateFailureAndUpdateLists",
          });
          Sa({
            type: "listCreateFailureAndUpdateLists",
          });
        },
        ...
        cb_bm_loadBookmark_success: function (a, c) {
          ...
          if (k.generated == false) {
            ...
            d.saved && a.bookmarkInfo && Ya(d, a.bookmarkInfo, Va("title mode tags unread alert description datetime onlyInGroup lists outliners"));
              ...
              M(a.annotations, function (f) {
                var h = N.add(
                  Ya(
                    ...
                    f,
                    Va("id user realName mode type content datetime extra groups onlyInGroup")
                  ),
                  {
                    dontPaint: true,
                    dontSort: true,
        ...
        saveBookmark: function (a, c, d, f) {
          x.Messenger.send({
            name: "updateBrowserActionIconToDoing",
          });
          var h = k.bookmark,
            i = {
              url: h.url,
          ...
          if (typeof f != "undefined") {
            ...
            i.unread = f.unread === true ? (h.unread = true) : (h.unread = false);
        ...
        cb_bm_saveBookmark_success: function (a, c, d) {
          ...
          if (a.groups.length > 0) {
            ...
            if ((h = a.groups[0].access_mode) && (h == 5 || h == 6)) {
              h = "https://team.diigo.com/site/text_view/" + f(a.groups[0].idInGroup);
              k.notify(
          ...
          if (c == "qsave") {
            ...
            if (a.annotation) {
              ...
              $("#diigo-video-collector-loading").addClass("success").find("#diigo-video-loading-text").text("Success!");
              $("#diigo-video-collector-loading")
                .delay(800)
                .fadeOut(function () {
                  var m = $("#diigo-video-collector-loading").data("diigo-target");
                  $(m).attr("diigo-clipping", "false");
                  $(this).remove();
                });
            }
        ...
        cb_bm_saveBookmark_failure: function (a, c) {
          if (this.count > 0) {
            ...
            if (a == 500)
              ...
              a == 0 &&
                L.notifyAlert(chrome.i18n.getMessage("bookmark_network_error"), {
                  timeout: 0,
                });
          ...
          if (k.bookmark.saved) {
            ...
            chrome.storage.local.get(null, function (i) {
              if (i.researchMode) {
                ...
                K.get(["prefs.bookmark.privateByDefault", "prefs.bookmark.unreadByDefault"], function (m) {
                  if (m["prefs.bookmark.privateByDefault"] == "true") l.mode = 2;
                  if (m["prefs.bookmark.unreadByDefault"] == "true") l.unread = true;
        ...
        cb_ic_add_success: function (a) {
          ...
          a.__annotation_groups && N.find(a.annotationId).addGroups(a.__annotation_groups);
          a.__bookmark_groups && k.bookmark.addGroups(a.__bookmark_groups);
        },
        ...
        loadMyStuff: function (a) {
          a = a || "myTags myGroups myProfile myBookmarkLists myContacts permissions";
      ...
      da = {
        ...
        init: function () {
          var a = this;
          a.create();
          a.j.find("a.diigoletButton,#diigolet-tb-btnHide").bind("focus", function () {
            this.blur();
          });
          a.jHelpTip = Q("diigolet-help");
          a.j.find(".diigoletButton,._hoverAndHideDropdown").bind("mouseover", function () {
            a.jHelpTip.hide();
            var c = $(this).attr("id");
            c == "diigolet-button-highlight" || c == "diigolet-button-highlight-dropdown" || $(this).is(".hover") || a.j.find(".dropdownMenu").hide();
          });
        },
        destroy: function () {},
        onSignIn: function () {
        ...
        updateUI: function () {
          !k.signedIn ? $("#diigolet-tb-btnSignIn b b").show() : $("#diigolet-tb-btnSignIn b b").hide();
          $("#diigolet-tb-btnMyBookmarks").hide();
          this.updateUsername();
          $("#diigolet-tb-btnComment").toggleClass("commented", k.isCommented());
        ...
        create: function () {
          ...
          $("._diigomenu").click(function (f) {
            ...
            if (className.indexOf("URL_MY_LIBRARY") >= 0) h = x.urls.getUserBookmarksPageURL();
            else if (className.indexOf("URL_MY_LIST") >= 0) h = x.urls.getListHome();
            else if (className.indexOf("URL_MY_GROUP") >= 0) h = x.urls.getGroupHome();
            else if (className.indexOf("URL_NETWORK") >= 0) h = x.urls.getNetwork();
            else if (className.indexOf("URL_HOT_BOOKMARK") >= 0) h = x.urls.getHotBookmark();
            x.openURL(h);
            return false;
          });
          if (k.launchMode.permalink) {
            $("#diigolet-tb-forward").show();
            $("a._forwardPageUrl", c).attr({
              href: k.bookmark.url,
            });
            a = k.permalinkParams.user;
            $("a._forwardUserUrl", c)
              .attr({
                href: a ? "https://www.diigo.com/user/" + a : "https://www.diigo.com",
              })
              .text(a || "Diigo");
        ...
        onHighlightColorChanged: function (a) {
          $("#diigolet-button-highlight").removeClass(k.defaultColors.join(" ")).addClass(a);
    ...
    var J = {
        ...
        if (!this.shown) {
          ...
          k.bookmark.saved == false &&
            chrome.storage.local.get(null, function (d) {
              d.researchMode === true && $("#diigolet-panel-btnBookmark").addClass("diigo-research-mode");
            });
      ...
      updateUI: function () {
        var a = $("#diigolet-panel-btnBookmark").toggleClass("saved", k.bookmark.saved);
        k.bookmark.saved && a.attr("title", "Saved. Click to reorganize");
      },
      updateStatus: function (a) {
        a ? $("#diigolet-panel-status").text("Saving...") : $("#diigolet-panel-status").text("Saved");
      },
      create: function () {
        ...
        $("#diigolet-panel-colorPicker li").click(function (c) {
          ...
          window.getSelection().toString().length !== 0 ? x.handle(c, "highlight", "normal", d) : x.handle(c, "ChangeColor", d);
          c.preventDefault();
        });
      ...
      unfold: function () {
        ...
        this.j.removeClass("fold").animate(
          {
            left: c - f + "px",
          },
          150,
        ...
        S =
          {
            ...
            isHighlightElement: function (a) {
              try {
                if (
                  a.nodeType == 1 &&
                  a.className &&
                  (a.className.indexOf(this.HIGHLIGHT_CLASS) > -1 || a.className.indexOf(this.HIGHLIGHT_ICON_CLASS) > -1)
                ) {
                  var c = {
                    type: -1,
                    ids: [],
                  };
                  c.type = Number(a.className.match(RegExp(this.HIGHLIGHT_TYPE_CLASS + "(\\d)"))[1]);
                  ac(a.className, RegExp(this.HIGHLIGHT_ID_CLASS + "([^\\s]+)(?:\\s|$)", "img"), function (f) {
                    c.ids.push(f[1]);
                  });
            ...
            domSnapshotNodeFilter: function (a) {
              ...
              if (a.tagName && this.tagBlackList.indexOf("," + a.tagName.toLowerCase() + ",") > -1) return false;
            ...
            isHighlightableNode: function (a) {
              return a.nodeType == 3 || (a.nodeType == 1 && S.tagBlackList.indexOf("," + a.tagName.toLowerCase() + ",") == -1);
            },
            findOffset: function (a, c, d, f) {
              ...
              if (d) {
                ...
                for (h = a.length - c.length; h >= f; h--) if (a.slice(h).replace(/\s+/g, "").indexOf(c) > -1) return h;
              } else {
                c = c.slice(Math.max(0, c.length - f - 1));
                for (h = f; h <= a.length; h++) if (a.slice(0, h).replace(/\s+/g, "").indexOf(c) > -1) return h;
              }
              return d ? a.length : 0;
            },
              ...
              if (d == h) {
                ...
                if (i.startOffset !== undefined)
                  for (c = i.startOffset + a.length; c <= l.length; c++)
                    if (l.slice(i.startOffset, c).replace(/\s+/gm, " ").indexOf(a) > -1) {
                      i.endOffset = c;
                      break;
                    }
              } else {
            ...
            seek: function (a, c) {
              ...
              if (f == -1) return null;
              h = f + d.length - 1;
              for (var l = this.docTxtOffsetList, m, t, D, A, G, q = undefined, o = 0, r = l.length; (i = l[o]), o < r; o++) {
                if (f == i.offset || (f > i.offset && (o + 1 == l.length || f < l[o + 1].offset))) {
                  m = i.node;
                  q = i;
                }
                if (h == i.offset || (h > i.offset && (o + 1 == l.length || h < l[o + 1].offset))) {
                  t = i.node;
                  D = i;
            ...
            paint: function (a) {
              function c(n, u) {
                $(n)
                  ...
                  .removeClass("yellow blue green pink")
                  .addClass(u.extra.color && u.extra.color.length > 0 ? u.extra.color : "yellow");
                return n;
              }

              function d(n) {
                var u = $(n.parentNode);
                u.hasClass(S.HIGHLIGHT_CLASS) ? u.addClass(l) : $(n).wrap(c(Ba.createElement("em"), i));
              }
              ...
              function f(n, u) {
                $(n)
                  ...
                  .toggleClass(
                    "group",
                    u.inAnyGroups() && m.length > 0 && (H.getCommentsInfo(u.comments) == "onlyGroup" || H.getCommentsInfo(u.comments) == "both")
                  )
              ...
              if (i.paintedSuccessfully) {
                ...
                if (t) {
                  ...
                  if (t.startNode === t.endNode) {
                    if (t.endOffset <= t.startOffset) t.startOffset = t.endOffset - t.txt.length;
                    ...
                    new sa(
                      ...
                      function (n) {
                        if (!G && n === D) G = true;
                        G && n.nodeType == 3 && n.nodeValue.replace(/(^\s+|\s+$)/gm, "").length > 0 && q.push(n);
                        if (G && n === A) {
                          G = false;
                          throw sa.$end;
                        }
                  ...
                  if (i.type == ia && $("div." + l).size() <= 0 && a.size() > 0) {
            ...
            adjustIconBg: function (a) {
              ...
              try {
                $("em." + S.HIGHLIGHT_ID_CLASS + a.id)
                  .parents()
                  .filter(function () {
                    var h = c.getComputedStyle(this, null).getPropertyValue("background-color");
                    if (h != "transparent") {
                      d = h;
                      throw "end";
                    }
              ...
              $("div.diigoIcon.diigoHighlightcommented.private." + S.HIGHLIGHT_ID_CLASS + a.id).attr(
                "style",
            ...
            adjustColor: function (a) {
              function c(d) {
                ...
                d = d.b / 255;
                return (
                  0.2126 * (f <= 0.03928 ? f / 12.92 : Math.pow((f + 0.055) / 1.055, 2.4)) +
                  0.7152 * (h <= 0.03928 ? h / 12.92 : Math.pow((h + 0.055) / 1.055, 2.4)) +
                  0.0722 * (d <= 0.03928 ? d / 12.92 : Math.pow((d + 0.055) / 1.055, 2.4))
                );
              }
              a = N.find(a);
              $("em." + S.HIGHLIGHT_ID_CLASS + a.id).each(function (d, f) {
                ...
                i = (l + 0.05) / (m + 0.05) > 2.5 ? null : c(i) > 0.5 ? "#000000" : "#FFFFFF";
                i && h.css("color", i);
              });
            },
            unpaint: function (a) {
              ...
              $("em." + c).each(function (d, f) {
                ...
                for (var i; (i = f.firstChild); ) f.parentNode.insertBefore(i, f);
                h.remove();
              });
            },
            isTextSelected: function () {
              return window.getSelection
                ...
                : $.browser.msie
                ? document.selection.type == "Text" && Qa(document.selection.createRange().text).length > 0
                : false;
            },
            checkSelection: function () {
              ...
              if (!this.isTextSelected()) {
                d.msg = "The number of highlighted non white space characters needs to be between 5 and 2000. Please select some text and try again.";
                d.pen = true;
                return d;
              }
                  ...
                  if (
                    !(function (l) {
                      ...
                      for (var m = 0; m < l.length; m++) {
                        var t = $(l[m]);
                        if (t.is(".diigoHighlight,.diigolet") || t.parents(".diigoHighlight,.diigolet").length > 0) return false;
                      }
                      return true;
                    })(c)
                  ) {
                    I("[H] checkRange returned false. selection not highlightable");
                    d.msg = "Selection cannot be highlighted.";
                    return d;
                  }
                  f = c.endContainer;
                } else d.html = String(a);
              } else d.html = $.browser.msie ? this.range2html(document.selection.createRange()) : document.getSelection();
              d.txt = this.html2txt(d.html);
              if (d.txt.length > 3e3) {
                d.msg = "The number of highlighted non white space characters needs to be between 5 and 2000. Please select some text and try again.";
                return d;
              }
              if ($("<div></div>").html(d.html).find(".diigoHighlight,.diigolet").size() > 0) {
                d.msg = "Selection cannot be highlighted.";
                return d;
              }
              d.ok = true;
            ...
            range2html: function (a) {
              return this.stripScripts(a.htmlText == undefined ? $("<div></div>").append(a.cloneContents()).html() : a.htmlText);
            },
            stripScripts: function (a) {
              return a.replace(RegExp("(?:<script.*?>)((\n|\r|.)*?)(?:</script>)", "img"), "");
            },
            html2txt: function (a) {
              ...
              new sa(
                ...
                {
                  filter: function (f) {
                    return f.nodeType == 3 || (f.nodeType == 1 && c.tagBlackList.indexOf("," + f.tagName.toLowerCase() + ",") == -1);
                  },
                }
              ).walk();
              a.remove();
            ...
            html2txt_pretty: function (a) {
              a = $("<div></div>").html(this.stripScripts(a)).appendTo(document.body);
              var c, d;
            ...
            node2txt: function (a) {
              var c = "",
                d = 3;
              new sa(a, function (f) {
                if (f.nodeType == 3 && $(f).parents("script,style,noscript").size() == 0) c += (d == 3 ? "" : "\n") + f.nodeValue;
                d = f.nodeType;
              }).walk();
    ...
    var H = {
      ...
      init: function () {
        if ($("#diigolet-dlg-sticky").length === 0) {
          ...
          setTimeout(function () {
            a.j
              .bind("mouseleave", function () {
                a.dragging || k.draggingFloatNote || a.isEditing() || a.scheduleHide();
              })
          ...
          $(".FN-switcher").on("click", function (c) {
            if (c.target.id == "FN-switcher-private" || c.target.parentNode.id == "FN-switcher-private") a.switchTab("private");
            else if (c.target.id == "FN-switcher-group" || c.target.parentNode.id == "FN-switcher-group") a.switchTab("group");
          });
          $("#diigolet-dlg-sticky-addTab").on("click", function () {
            if (!($("#FN-group-content-postform").find("button").prop("disabled") == true || $("#FN-group-post").prop("disabled") == true))
          ...
          $("#FN-current-group").on("click", function (c) {
            c.stopPropagation();
            $("#FN-group-content-postform").find("button").prop("disabled") == true ||
          ...
          $("#FN-group-menu").on("click", "li", function (c) {
            if (c.target.id == "FN-group-share-new") {
              ...
              M(k.myGroups, function (f) {
                $("#FN-group-ul").find('li[data-dgroupname="' + f.name + '"]').length == 0 &&
                  d.append(
                    E.dom.buildOne(
                      "option",
                      {
          ...
          $("#FN-post-form")
            .find("a")
            .on("click", function () {
              if ($("#FN-group-content-container").find(".FN-group-content-section").length > 0) {
                a.j.removeClass("groupNew");
          ...
          $("#FN-group-content-container").on("click", ".FN-group-comment-item-delete", function () {
          ...
          $("#FN-private-saveBtn").on("click", function () {
            if (!$("#FN-private-editor").val().match(/^\s*$/)) {
              a.ann.onlyInGroup || !a.ann.saved || a.getCommentCount("private", a.ann.comments) == 0
                ? a.addPrivateComment()
      ...
      updateColor: function (a, c) {
        $("#diigolet-dlg-sticky-color").find(".dlg-colorItem").removeClass("colorchecked");
      ...
      show_: function (a, c, d, f, h) {
        ...
        setTimeout(function () {
          ...
          if (f === "add") {
            ...
            i.switchTab("private");
            i.j.removeClass("onlyGroup").addClass("onlyPrivate").addClass("groupNew");
            $("#FN-group-ul").empty();
            $("#FN-current-group").find("span").text("+Share to a new group");
          ...
          M(k.myGroups, function (A) {
            $("#FN-group-ul").find('li[data-dgroupname="' + A.name + '"]').length == 0 &&
              D.append(
                E.dom.buildOne(
                  "option",
                  {
          ...
          i.j.hasClass("onlyPrivate")
            ...
            : $("#diigolet-dlg-sticky-addTab").attr("title", "Add a private note");
        }, h);
      },
      mergePrivateComments: function (a) {
        for (var c = this.ann, d = c.comments.length, f = [], h = 0; h < d; h++) c.comments[h].mode === 2 && f.push(c.comments[h].id);
        a = {
          annotationId: c.id,
          mode: 2,
          content: a,
      ...
      reSetIcWindow: function () {
        ...
        $("#FN-group-content-postform").find("textarea,button").prop("disabled", false);
      ...
      showActionDropdown: function () {
        ...
        if (d.type == fa) {
          ...
          d.extra && d.extra.color && d.extra.color.length > 0
            ? Q("diigolet-context-" + d.extra.color).toggleClass("colorchecked", true)
      ...
      switchGroup: function (a) {
        $("#FN-group-content-container").find(".FN-group-content-section").hide();
        $('.FN-group-content-section[data-dgroup="' + a.name + '"]').show();
        $("#FN-current-group").find("span").text(a.displayName).attr("data-group", a.name);
      },
      ...
      privateEditOn: function (a) {
        if (a === true) $("#FN-content-footer").find("#editDone").hide().end().find("#editing").show();
        else a === false && $("#FN-content-footer").find("#editing").hide().end().find("#editDone").show();
      },
      ...
      showNoComments: function () {
        this.ann.getComments(this.filterMode).length == 0 &&
          this.j.find("div.diigoletFNContent").html('<span class="noComments">There are no sticky notes yet.</span>');
      },
      updatePos: function (a) {
        ...
        var f = c.type != 2 ? a.pageX - 8 : parseInt(c.getEle().css("left")) + 20;
    ...
    W(H, {
      ...
      _labelsHtml: function (a) {
        ...
        if (a.isPrivate() && (c == "_all" || c == "_private"))
          d += '<label class="_private"><span>Private</span>DEL</label>'.replace(
            "DEL",
            Y(f, {
              ONCLICK: "diigolet.handle(event, 'dlgIC_del_ic', '" + a.id + "')",
            })
        ...
        M(a.groups, function (h) {
          if (c == h.name || c == "_all")
            d += Y('<label class="_#{GROUP_NAME}"><a href="#{GROUP_URL}" class="link">#{GROUP_DISPLAY_NAME}</a>#{DEL}</label>', {
              GROUP_NAME: h.name,
              GROUP_DISPLAY_NAME: h.displayName,
              GROUP_URL: x.urls.getGroupURL(h.name),
              DEL: Y(f, {
                ONCLICK: "diigolet.handle(event, 'dlgIC_del_ic', '" + a.id + "', '" + h.name + "')",
              }),
            });
        });
        return d;
      ...
      addInlineComment: function (a) {
        if (a.mode == 2) {
          /minute|day|hour/.test(a.datetime) ? $("#FN-private-datetime").text("") : $("#FN-private-datetime").text(a.datetime.replace("on ", ""));
          ...
          if (this.j.hasClass("groupNew")) {
            $("#FN-group-content-container").append('<div class="FN-group-content-section" data-dgroup="' + c + '"></div>');
            $("#FN-group-ul").append('<li data-dGroupName="' + c + '" title="' + d + '">' + d + "</li>");
            this.j.removeClass("groupNew");
            this.switchGroup({
              name: c,
              displayName: d,
            ...
            $("#FN-group-content-container")[0].scrollTop = $("#FN-group-content-container")[0].scrollHeight;
      ...
      getCommentsInfo: function (a) {
        ...
        return c == 0 && d == 0 ? "noComment" : c > 0 && d == 0 ? "onlyPrivate" : c == 0 && d > 0 ? "onlyGroup" : "both";
      },
      ...
      updatePrivateComments: function (a) {
        ...
        if (f != "" && h) {
          /minute|day|hour/.test(f) || $("#FN-private-datetime").text(f.replace("on ", ""));
      ...
      updateGroupComments: function (a) {
        ...
        if (a.length != 0) {
          for (var h = 0; h < a.length; h++)
            if (a[h].mode === 3) {
              f.push(a[h]);
              for (var i = 0; i < a[h].groups.length; i++) c[a[h].groups[i].name] = a[h].groups[i].displayName;
            }
          a = $("#FN-group-ul").empty();
          for (g in c) {
            a.append('<li data-dGroupName="' + g + '" title="' + c[g] + '">' + c[g] + "</li>");
            d += '<div class="FN-group-content-section" data-dgroup="' + g + '"></div>';
          }
          ...
          for (c = 0; c < f.length; c++) {
            ...
            for (a = 0; a < d.length; a++) {
              ...
              $('.FN-group-content-section[data-dgroup="' + d[a].name + '"]').append(h);
            }
          }
        }
      },
      generateGroupItem: function (a) {
        ...
        return Y(
          '<div class="FN-group-comment-item" data-cid="#{ID}"><div class="FN-group-comment-item-tbar"><a href="#" class="FN-group-comment-name">#{USERNAME}</a><span class="FN-group-comment-item-time">#{DATETIME}</span>#{DELETE}</div><div class="FN-group-comment-item-content">#{CONTENT}</div></div>',
          {
            ...
            CONTENT: a.content,
            DATETIME: a.datetime,
            DELETE: k.user == a.user ? '<a class="FN-group-comment-item-delete">delete</a>' : "",
          }
        );
      },
      ...
      removeInlineComment: function (a, c) {
        ...
        if ($('.FN-group-content-section[data-dgroup="' + c + '"]').find(".FN-group-comment-item").length == 0) {
        ...
        $("#FN-group-ul").find("li").length != 0 && $("#FN-group-ul").find("li").trigger("click");
      },
      ...
      groupEditor: {
        ...
        submitGroupComment: function () {
          ...
          if (c) {
            ...
            $("#FN-group-content-postform").find("textarea,button").prop("disabled", true);
          } else {
        ...
        show: function () {
          var a = $(".diigoletFNPriSlct").empty(),
            c = H.ann,
            d = H.filterMode;
          if ((d == "_all" || d == "_public") && (c ? true : true) && (c ? !c.onlyInGroup && c.getComments("_private").length == 0 : true))
            H.NO_PUBLIC_STICKY_NOTES_ALLOWED || a.append('<option value="_public">Public</option>');
          if ((d == "_all" || d == "_private") && (c ? !c.onlyInGroup && c.getComments("_public").length == 0 : true))
            a.append('<option value="_private">Private</option>');
          M(k.myGroups, function (h) {
            if ((d == "_all" || d == h.name) && (c && (c.user != k.user || c.onlyInGroup) ? c.inGroup(h.name) : true))
              a.append(
                E.dom.buildOne(
                  "option",
                  {
          ...
          if (a.find("option").length == 0) H.j.find(".diigoletFNComment").hide();
          else {
    ...
    var U = {
        ...
        show: function (a, c) {
          if (!(!k.signedIn || (this.shown && this.j.is(":visible")))) {
            ...
            this.j.show();
            var d = this;
            if (k.recommendedTagsLoaded) d.showRecommendedTags(k.recommendedTags);
            else {
              ...
              z.loadRecommendedTags(f.url, h, function () {
                I(k.keywords);
                if (k.keywords.length > 0) k.recommendedTags = db($.merge(k.keywords, k.recommendedTags));
            ...
            a && c ? this.syncData("saveLink", true, a, c) : this.syncData("data->form", true);
            d.refreshPremium();
            $("#Diigo-Bookmark-uploadCache").find(".op-checkbox-container").removeClass("checked");
            $("#Diigo-Bookmark-Tag-Input").focus();
            d.showPromotionMessage();
            /https:\/\/www.hnsearch.com\/search/.test(window.location.href) &&
              $("#Diigo-Bookmark-Url,#Diigo-Bookmark-Title,#Diigo-Bookmark-Description,#Diigo-Bookmark-Tag").bind("focus", function () {
        ...
        showTagList: function (a, c) {
          ...
          } else if (a == "recommend" && f.find(".tagButton").length > 0) return;
          if (c)
              ...
              M(c, function (l) {
                var m = $(
                  E.dom.buildOne(
                    "div",
                    {
                      id: "diigolet-tag-" + a + "-" + d.escapeTagForElementId(l),
                      class: "tagButton",
                      tag: l,
                    },
                    [l]
                ...
                m.toggleClass("selected", $.inArray(l, h.tags) >= 0).toggleClass("inused", $.inArray(l, i) >= 0);
                m.click(function () {
                  d.toggleTag(l);
                  return false;
                });
        ...
        updateTagStates: function () {
          ...
          $("#Diigo-Bookmark-Tag-Cloud")
            ...
            .each(function () {
              var f = $(this),
                h = f.text();
              $.inArray(h, d) != -1 ? f.addClass("selected") : f.removeClass("selected");
            });
          a.tagListNames.forEach(function (f) {
            $(a._tagContainerIdForTagListName(f))
              ...
              .each(function () {
                var h = $(this),
                  i = h.attr("tag");
                $.inArray(i, d) != -1 ? h.addClass("selected") : h.removeClass("selected");
              });
          });
        },
        ...
        create: function () {
          ...
          $("#diigolet-dlgBm-btnSave").click(function (d) {
            a.j.data("data-ifSaveLink") == true ? a.saveThisLink() : x.handle(d, "bmOnSubmitAndClose", "bookmark");
          });
          $("#diigolet-dlgBm-btnSaveandmore").click(function (d) {
            ...
            window.open("https://www.diigo.com/toolbar/saved?t=" + d + "&url=" + f + "&tags=" + h);
          });
          var c = navigator.userAgent.toLowerCase();
          (c.indexOf("macintosh") != -1 || c.indexOf("mac os x") != -1) && $("#list-group select").css("text-indent", "7px");
          $("#Diigo-Bookmark-Title")
            .find("#link-icon")
            .on("click", function () {
              var d = $("#Diigo-Bookmark-Url");
              d.hasClass("unfold") ? d.addClass("fold").removeClass("unfold") : d.addClass("unfold").removeClass("fold");
            })
            .Gtooltip({
              position: "top",
            });
          ...
          a.j.bind("keydown", function (d) {
            if (d.keyCode == 13) {
              if (d.target.tagName.toLowerCase() != "textarea" || d.ctrlKey) x.handle(d, "bmOnSubmitAndClose", "bookmark");
          ...
          $("#diigo-list-addBtn").on("click", function () {
            if (!$(this).hasClass("processing")) {
              ...
              else if ($.inArray(d, h) !== -1) f.show().find("span").text("Name existed !");
              else {
          ...
          $("#diigolet-tagForward-remove").click(function (d) {
            d.preventDefault();
            if (!k.isAnnotated() || confirm("Removing this as a bookmark will also remove your annotations on this page. Do you want to continue?")) {
        ...
        buildTagCloud: function (a, c) {
          document.getElementById("Diigo-Bookmark-Tag-Eidt").href = "https://www.diigo.com/cloud/" + k.user;
          if (k.myTagsWithCount.length == 0) {
            ...
            f.innerHTML = "No tags";
            d.appendChild(f);
          } else if (!($("#Diigo-Bookmark-Tag-Cloud-Container").find("a").length > 0)) {
            var h = this,
              i = Rb();
            d = i.topTags;
            var l = i.maxCount;
        ...
        syncData: function (a, c, d, f) {
          ...
          if (a == "data->form") {
            $("#diigolet-tagForward-remove")
              .toggle(i.saved)
              .attr("data-gtooltip", "Saved " + i.datetime + ". Click to remove");
            this.j.data("data-ifSaveLink", false);
            i.saved == true && $("#diigolet-tagForward-topBar").find(".topBar-title").text("Edit bookmark");
            ...
            if (c || i.saved) {
              ...
              i.mode == 2
                ? $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").addClass("checked")
                : $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").removeClass("checked");
              i.unread == true
                ? $("#Diigo-Bookmark-Unread").find(".op-checkbox-container").addClass("checked")
                : $("#Diigo-Bookmark-Unread").find(".op-checkbox-container").removeClass("checked");
            }
            $("#Diigo-Bookmark-uploadCache").show();
            h.buildTagCloud("Diigo-Bookmark-Tag-Cloud-Container", "Diigo-Bookmark-Tag-item");
            h.updateTagStates();
            ...
            i.saved == false
              ? chrome.storage.local.get(null, function (l) {
                  if (l.researchMode == true) {
                    $("#diigolet-tagForward-topBar").find(".focus-research-tip").show();
            ...
            i.mode = $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").hasClass("checked") ? 2 : 0;
            i.unread = $("#Diigo-Bookmark-Unread").find(".op-checkbox-container").hasClass("checked");
            i.description = $("#Diigo-Bookmark-Description-Input").val();
            a = $("#diigo-group").find("select").val();
            if (a == "-1" || a == "-2" || a == "0") i.toShareToGroups = [];
            else {
              i.toShareToGroups = [a];
              i.toShareExistingAnnotations = $("#Diigo-Bookmark-checkShareExisting").find(".op-checkbox-container").hasClass("checked");
            }
            a = $("#diigo-list").find("select").val();
            i.toAddToBookmarkLists = a == "-1" || a == "-2" || a == "0" ? [] : [a];
          } else if (a == "saveLink") {
        ...
        fillReasearchModeData: function (a) {
          ...
          a["private"]
            ? $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").addClass("checked")
            : $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").removeClass("checked");
          a.unread && $("#Diigo-Bookmark-Unreadr").find(".op-checkbox-container").addClass("checked");
          $("#Diigo-Bookmark-Description-Input").val(a.description);
          var c = Wb.unparseTags(a.tags);
          $("#Diigo-Bookmark-Tag-Input").val(c);
          this.updateTagStates();
          a.shareLists.length && $("#diigo-list").find("select").val(a.shareLists[0]);
          a.shareGroups.length && $("#diigo-group").find("select").val(a.shareGroups[0]);
        },
        updateLists: function (a) {
          j = $("#diigo-list").find("select").empty().unbind().removeClass("processing");
          j.append(
            E.dom.buildOne(
              "option",
              {
        ...
        updateGroups: function (a) {
          var c = this,
            ...
            h = $("#diigo-group").find("select").empty().unbind().removeClass("processing");
          if (f.length > 0) {
            h.append(
              E.dom.buildOne(
                "option",
              ...
              a
                ...
                : h.append(
                    E.dom.buildOne(
                      ...
                      [i.displayName + (k.bookmark.inGroup(i.name) ? " (shared)" : "")]
                    )
                  );
            });
            h.append(
        ...
        afterGroupSelectionChange: function () {
          var a = $("#diigo-group").find("select").val() != "-1" && $("#diigo-group").find("select").val() != "0";
        ...
        submitAndClose: function () {
          ...
          if (a) {
            ...
            var f = function () {};
            $("#Diigo-Bookmark-uploadCache").find(".op-checkbox-container").hasClass("checked") &&
              (function (h) {
                f = function () {
            ...
            x.ready = true;
            this.hide();
            $("#Diigo-Bookmark-checkShareExisting").find(".op-checkbox-container").removeClass("checked");
          }
        },
        saveThisLink: function () {
          ...
          if (c) {
            ...
            a.mode = $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").hasClass("checked") ? 2 : 0;
            a.unread = $("#Diigo-Bookmark-Unread").find(".op-checkbox-container").hasClass("checked");
        ...
        refreshPremium: function () {
          ...
          if (Fa.hasCacheUpload()) {
            ...
            c.attr("title", "Upload a copy of the page (Quota exceeded. Go premium to re-enable.)");
          }
        },
      },
      La = {
        ...
        create: function () {
          ...
          this.container = $(k.launchMode.threeDForum ? "#diigo-3dforum" : "#diigolet-annotationSummary");
        ...
        refreshPageComments: function () {
          ...
          M(k.pageComments, function (d) {
            c += Y(
              '<li class="bgColor3"><a class="avatar" href="#{DIIGO_URL}/user/#{USER}" title="#{USER}" target="_blank"><img alt="#{USER}" src="http://resources.diigo.com/resources_mana/user_avatar?user_name=#{USER}&amp;size=48" /></a><span class="commentInfo color1"><a href="#{DIIGO_URL}/user/#{USER}" target="_blank" class="color1">#{USER} </a>#{DATE}\n\t\t\t</span ><p class="labelList">#{LABELS_HTML}</p><p class="commentBody color2">#{CONTENT}</p></li>\n',
              {
                USER: d.user,
          ...
          $("#d3df-pageCommentList").html(c || '<li class="bgColor3 color1"><div class="noComments">No comments yet</div></li>\n');
        ...
        refreshInlineComments: function () {
            ...
            if (i.type == 0 || i.type == 2 || i.type == 1) {
              ...
              c = Y(
                '<li class="highlight"><a class="highlight headingColor2 #{FLOAT_NOTE_CLASS}" href="#" onclick="diigolet.devil(\'Sidebar\').jumpToHighlight(\'#{ID}\');return false;"><span class="jumpTo color1" style="float:right">...Jump to</span><em style="font-style:italic;line-height:24px;width:80%;" class="color2">#{CONTENT}</em></a><ul class="comments bgColor1">#{COMMENTS}\n</ul></li>\n',
                {
                  ...
                  CONTENT: E.content2Html(i.prettyTxt || ab.html2txt_pretty(i.content)),
                  COMMENTS: d,
                }
              );
              a += c;
          ...
          var h = '<li class="bgColor3 color1"><div class="noComments">No comments yet</div></li>\n';
          k.launchMode.threeDForum || (h = h.replace("No comments", "No sticky notes"));
        ...
        addCommentSubmit: function () {
          ...
          if (a.length <= 0 || a.length > 500) alert("Comment length should < 500 characters");
          else {
    ...
    W(La, {
      ...
      _labelsHtml: function (a) {
        var c = a.annotationId ? "ic" : "pc",
          ...
          f = "",
          h = a.canDelete()
            ? '<a href="javascript:void(0)" class="del" onclick="#{ONCLICK};"><img title="Delete" src="http://www.diigo.com/client/ietoolbar/spacer.gif" style="width:12px;height:12px;cursor:pointer" alt="" /></a>'
            : "";
        if (a.isPublic() && (d == "_all" || d == "_public") && a.user == k.user)
          f += '<label class="_public"><span>Public</span>DEL</label>'.replace(
            "DEL",
            Y(h, {
              ONCLICK: Y("diigolet.handle(event, 'sb_del_#{0}', '#{1}')", [c, a.id]),
            })
          );
        if (a.isPrivate() && (d == "_all" || d == "_private"))
          f += '<label class="_private"><span>Private</span>DEL</label>'.replace(
            "DEL",
            Y(h, {
              ONCLICK: Y("diigolet.handle(event, 'sb_del_#{0}', '#{1}')", [c, a.id]),
            })
        ...
        M(a.groups, function (i) {
          if (d == i.name || d == "_all")
            f += Y('<label class="_#{GROUP_NAME}"><a href="#{GROUP_URL}" class="link">#{GROUP_DISPLAY_NAME}</a>#{DEL}</label>', {
              GROUP_NAME: i.name,
              GROUP_DISPLAY_NAME: i.displayName,
              GROUP_URL: x.urls.getGroupURL(i.name),
              DEL: Y(h, {
                ONCLICK: Y("diigolet.handle(event, 'sb_del_#{0}', '#{1}', '#{2}')", [c, a.id, i.name]),
              }),
            });
        });
        return f;
    ...
    var ga = {
                ...
                function (m) {
                  if (k.generated == false) {
                    ...
                    if (m.loadBookmarkResult) {
                      ...
                      z.cb_bm_loadBookmark_success(m.loadBookmarkResult, "prepareCtx");
                    } else m.shouldLoadBookmarkByMyself && k.signedIn && z.loadBookmark();
                  }
                  if (m.globalData.user == "") k.notify(Da, 1e3);
                  else {
                    K.get("prefs.lastUsedColor", function (t) {
                      J.shown ? x.handle(l, "highlight", "normal", t) : x.handle(l, "highlight", "small", t);
                    });
                    return false;
                  }
                }
              ...
              function (D) {
                if (k.generated == false) {
                  ...
                  if (D.loadBookmarkResult) {
                    ...
                    z.cb_bm_loadBookmark_success(D.loadBookmarkResult, "prepareCtx");
                  } else D.shouldLoadBookmarkByMyself && k.signedIn && z.loadBookmark();
                }
                if (D.globalData.user == "") k.notify(Da, 1e3);
                else {
                  if (J.shown)
                    if (t == "diigolet-csm-highlight-wrapper") x.handle(l, "highlight", "normal", m);
                    else t == "diigolet-csm-highlightAndComment-wrapper" && x.handle(l, "highlightAndComment", "normal", m);
                  else if (t == "diigolet-csm-highlight-wrapper") x.handle(l, "highlight", "small", m);
                  else t == "diigolet-csm-highlightAndComment-wrapper" && x.handle(l, "highlightAndComment", "small", m);
                  return false;
                }
              }
            );
              ...
              O.send(
                ...
                function (m) {
                  ...
                  if (m.globalData.user == "") k.notify(Da, 1e3);
                    ...
                    K.get("prefs.lastUsedColor", function (t) {
                      J.shown ? x.handle(l, "highlightAndComment", "normal", t) : x.handle(l, "highlightAndComment", "small", t);
                      return false;
                    });
                    return false;
                  }
            ...
            function () {
              ...
              if (m == "diigolet-csm-highlight") {
                ...
                d = setTimeout(function () {
                  l.parent().find(".diigolet-csm-color").animate(
                    {
                      height: 21,
                    },
                    200
                  );
                  l.parent().find(".diigolet-csm-coloritem").animate(
                    {
                      height: 7,
                    },
                    200
        ...
        show: function (a) {
          ...
          if (window.getSelection().toString().length > 0) {
            this.j
              ...
              .show();
            chrome.storage.local.get(null, function (d) {
              d.researchMode === true && k.bookmark.saved === false ? c.j.addClass("diigo-researchMode") : c.j.removeClass("diigo-researchMode");
            });
            this.shown = true;
          }
        },
        hide: function () {
          this.j.hide();
          $("#diigolet-csm .diigolet-csm-color").animate(
            {
              height: 0,
            },
            200
      ...
      Z = {
        ...
        init: function () {
          ...
          $("#diigolet-context-yellow,#diigolet-context-blue,#diigolet-context-green,#diigolet-context-pink").click(function () {
            var c = $(this).attr("color");
            ...
            Q("diigolet-annMenu-currentColor").removeClass("yellow blue green pink").addClass(c);
        ...
        buildMenu: function () {
          ...
          if (a.extra && a.extra.color && a.extra.color.length > 0) {
            Q("diigolet-annMenu-currentColor").removeClass("yellow blue green pink").addClass(a.extra.color);
            Q("diigolet-context-" + a.extra.color).toggleClass("colorchecked", true);
        ...
        tipMsg: function (a) {
          var c = "#{MODE} #{WHAT} by #{REALNAME}",
            d = {
              REALNAME: a.realName.trim() ? a.realName : a.user,
            };
          d.WHAT = a.type == x.ANNOTATION_TYPE_FLOATNOTE ? "floating sticky note" : "highlight";
          d.MODE = a.isPublic() ? "Public" : a.isPrivate() ? "Personal" : "Group";
          if (a.inAnyGroups()) {
            ...
            d.GROUPS = a.length == 1 ? a[0] : a.slice(0, a.length - 1).join(", ") + " and " + a[a.length - 1];
          }
          return Y(c, d);
        },
      },
        ...
        showMenu: function (a, c, d) {
          ...
          if (c.ann)
            if (c.ann.comments.length == 0)
              ...
              f = H.ann != c.ann;
              H.isEditing() || ((f || !H.shown) && !d ? H.scheduleShow(a, c.ann) : H.cancelHide());
            }
        },
        reset: function (a) {
          var c = this;
      ...
      yb = {
        ...
        isSupported: function (a) {
          return /youtube|aol|yahoo|myspace|vimeo|dailymotion|56\.com|youku|tudou|stupidvideos|metacafe/.test(a.toLowerCase()) ? true : false;
        },
        showView: function (a, c) {
          ...
          if (a == "loading") {
            $('<div id="diigo-video-capture-loading">Processing ...</div>').appendTo(d.k);
            d.k.addClass("show");
        ...
        bindEvents: function () {
          ...
          $(document)
            ...
            .on("mouseleave", "video", function (c) {
              (c.relatedTarget && c.relatedTarget.id == "diigo-video-capture") || a.j.hide();
            });
          a.k.find("#diigo-video-capture-wrapper-close").on("click", function () {
            a.k.find("img").remove();
    ...
    wb = {
      ...
      getBookInfo: function () {
        var a = $("h3.kp-notebook-metadata").text(),
          ...
          d = [];
        $("#kp-notebook-annotations>div.a-row.a-spacing-base").each(function () {
          var f = $(this),
            h = {},
          ...
          if (h.content) {
            if (i && i.match(/(.*)\s(highlight|surlignement)/) && i.match(/(page|location|emplacement):\s(.*)/)) {
              h.color = i.match(/(.*)\s(highlight|surlignement)/)[1];
              h.page = i.match(/page:\s(.*)/) ? i.match(/page:\s(.*)/)[1] : "";
              h.location = i.match(/location:\s(.*)/) ? i.match(/location:\s(.*)/)[1] : "";
              h.emplacement = i.match(/emplacement:\s(.*)/) ? i.match(/emplacement:\s(.*)/)[1] : "";
            } else {
              h.color = "yellow";
              h.location = "0";
            }
    ...
    chrome.runtime.onMessage.addListener(function (a, c, d) {
      if (k.chromeExtensionID == c.id || a.name == "run") (a.fromTabId && k.chromeTabId == a.fromTabId) || x.Messenger.onMessage(a, d);
    ...
    var O = (x.Messenger = {
        ...
        onMessage: function (a, c) {
          a.name != "dataURL" && this.handlers[a.name] && this.handlers[a.name](a, c);
        },
        handlers: {
          run: function (a) {
            ...
            if (Sb())
              ...
              alert(chrome.i18n.getMessage("refreshAfterUpdate", [chrome.i18n.getMessage("extName"), a]));
          ...
          signIn: function (a) {
            ...
            try {
              var c = a.user;
              I("onSignIn", c || "username unknown", "will loadMyStuff: ", false);
          ...
          prepareCtx: function () {
            O.send(
              ...
              function (a) {
                ...
                if (a.loadBookmarkResult) {
                  I("[bookmark info already loaded]", a.loadBookmarkResult);
                  z.cb_bm_loadBookmark_success(a.loadBookmarkResult, "prepareCtx");
          ...
          readlater: function (a) {
            if (qa()) {
              ...
              a = function () {};
              k.bookmark.unread == true ? z.saveBookmark(null, a, "readlater") : z.saveBookmark(null, a);
            }
          },
          annotate: function () {
            Xb.open();
            ...
            O.send(
              ...
              function (a) {
                ...
                K.get("prefs.autoload", function (c) {
                  c == "true" ? z.cb_bm_loadBookmark_success(a.loadBookmarkResult, "showbar") : z.cb_bm_loadBookmark_success(a.loadBookmarkResult);
                  setTimeout(function () {
                    if (!k.bookmark.saved) k.bookmark.title = document.title ? document.title : window.location.href;
                  }, 100);
          ...
          showWindow: function (a) {
            if (Ma(window.location.href)) {
              if (qa()) {
                if ("data" in a)
                  var c = a.data.linkTitle == null ? x.templinkTitle : a.data.linkTitle,
                    d = a.data.url;
                if ($("#diigolet-panel-panel").length == 0) {
                  L.init();
                  na();
                  O.send(
                    ...
                    function (f) {
                      if (x.version != f.version) {
                        ...
                        alert(chrome.i18n.getMessage("refreshAfterUpdate", [chrome.i18n.getMessage("extName"), f]));
          ...
          saveImageToDiigo: function (a) {
            if (a.data !== undefined)
              if (Ma(window.location.href))
                if (typeof k.permissions.imagePermission !== "undefined" && !k.permissions.imagePermission.imagePermission) {
                  ca.init();
                  ca.show("image");
                } else {
                  if (qa()) {
                    var c = a.data,
                      ...
                      f = k.bookmark.url ? k.bookmark.url : window.location.href,
                      h = [],
                    ...
                    if (a.type == "tag") ka.showSavePupop("image", c, l);
                      ...
                      chrome.storage.local.get(null, function (D) {
                        D.researchMode === true && k.bookmark.saved === false
                          ? z.uploadImage(m, t, false, f, {}, l, "", true, D.researchModeData)
          ...
          editItem: function (a) {
            if (a.annotation)
              if (aa && aa.j) a.cmd == "remove" || a.cmd == "changeColor" ? aa.editItem(a.cmd, a.annotation) : aa.editItem(a.cmd, null, a.annotation);
          },
    ...
    yb.init();
    /https:\/\/[\S]*\.amazon\.[\S]*\/notebook/.test(window.location.href) && wb.init();
    K.get("prefs.autoShowHighlightIcon", function (a) {
      I(window.location.hostname);
      if (!(window.location.hostname == "mail.google.com" || window.location.hostname == "docs.google.com"))
        if (a == "true") {
        ...
        function (c) {
          if (c)
            if (
              ...
              O.send(
                ...
                function (d) {
                  if (x.version != d.version) {
                    ...
                    alert(chrome.i18n.getMessage("refreshAfterUpdate", [chrome.i18n.getMessage("extName"), d]));
                  } else {
                    L.init();
                    na();
                    if (d.globalData.user == "") k.notify(Da, 1e3);
                    else {
                      k.generated == false && z.cb_bm_loadBookmark_success(d.loadBookmarkResult, "prepareCtx");
                      K.updateCache(d.preloadedPrefs);
                      Aa.makeSnapshot();
                      $("#diigolet-panel-panel").length == 0 &&
              ...
              String.fromCharCode(a.keyCode) == c["prefs.shortcutAnnotateArticleKey"]
            )
              Xb.open();
            else if (
              ...
              String.fromCharCode(a.keyCode) == c["prefs.shortcutAnnotatePDFKey"]
            )
              chrome.runtime.sendMessage({
                name: "openPdf",
                url: window.location.href,
              ...
              String.fromCharCode(a.keyCode) == c["prefs.shortcutAnnotateScreenshotKey"]
            )
              ka.initSelectedCapture();
            else
              c["prefs.shortcutOpenOutlinerSidebar"] == "true" &&
                ...
                String.fromCharCode(a.keyCode) == c["prefs.shortcutOpenOutlinerSidebarKey"] &&
                ma.toggle();
        }
      );
    });
        ...
        switch (a.data.type) {
          ...
          case "onload":
            ...
            if (a.data.outlinerId) {
              K.set({
                openedOutlinerId: a.data.outlinerId,
              });
            ...
            K.set({
              "prefs.outlinerFrameUrl": a.data.url,
            });
            break;
    ...
    var L = {
        ...
        create: function () {
          (this.j = $(pb).eq(0).appendTo(document.body).hide()).children().eq(0).siblings().remove();
        },
        destroy: function () {
          this.j.remove();
        },
          ...
          f.children("div:first")
            ...
            .click(function () {
              !$(this).attr("id") == "team_url" &&
                window.open("http://www.diigo.com/sign-in?referInfo=" + encodeURIComponent("/images/diigo-logo.png#SIGNED_IN"));
            });
          f.children("div:first")
            .children("span:first")
            .click(function () {
      ...
      ca = {
        ...
        show: function (a) {
          ...
          switch (a) {
            case "image":
              var h = '<span class="num red">' + d.imagePermission.imageUsedCount + "</span>";
              d = '<span class="num green">' + d.imagePermission.imageQuota + "</span>";
              h = "Your image number is over quota: " + d + " images for " + f + " Plan, you have " + h + " images.";
              var i = "Over Quota";
              break;
            case "highlight":
              h = '<span class="num red">' + d.annPermission.annotationUsedCount + "</span>";
              d = '<span class="num green">' + d.annPermission.annotationQuota + "</span>";
              h = "Your highlight number is over quota: " + d + " highlights for " + f + " Plan, you have " + h + " highlights.";
              i = "Over Quota";
              break;
            case "cache":
              h = "This feature is not available on your current plan. Please upgrade your plan to gain access to this feature.";
    ...
    Ab.Class = {
      ...
      extend: function (a, c) {
        ...
        for (var f in c) {
          var h = c[f];
          if (d && typeof h == "function" && E.func.argumentNames(h)[0] == "$super") {
            var i = h;
            h = E.extend(
              E.func.wrap(
                (function (l) {
    ...
    var ea = Ab.Class.create({
      ...
      setContacts: function (a, c) {
        ...
        ea.contacts = a;
        ea.contactListsID = [];
        for (var d = 0; d < ea.contacts.length; d++) ea.contacts[d].type == "list" && ea.contactListsID.push(d);
      },
      showNotice: function () {
        this.tip.attr({
          class: "accNotice",
      ...
      scanContacts: function () {
        ...
        for (var c = 0; c < ea.contacts.length; c++) {
          ...
          if (!(this.scanType != "all" && this.scanType != f.type)) {
            switch (f.type) {
              case "list":
                d = "&" + f.extra.title.replace(/\s+/, "&") + "&" + f.extra.note;
                break;
              case "friend":
      ...
      showContacts: function () {
        ...
        for (var a = this, c = 0; c < this.match.length; c++) {
          ...
          switch (f.type) {
            case "list":
              h.html("<b><i>list</i>" + this.h(f.extra.title) + "</b>" + f.extra.note);
              break;
            case "friend":
              str = "<b>" + this.h(f.extra.real_name) + "</b><span class='extraDesc'>(";
      ...
      h: function (a) {
        ...
        return a.replace(eval("/" + c + "/i"), "<span class='keywordStrong'>" + c + "</span>");
      },
      hoverItem: function (a) {
        this.currentItem >= 0 && this.outItem(this.currentItem);
        this.currentItem = a > this.match.length - 1 ? this.match.length - 1 : a < -1 ? -1 : a;
      ...
      wrapItem: function (a) {
        ...
        d = $('<a class="recItemRemove" href="javascript:void(0);" id="recItemRemove_' + a + '"></a>').html("x");
        c.append(d);
        c.attr("cIndex", a);
        c.insertBefore(this.recInput);
        var f = this;
        $("#recItemRemove_" + a).bind(
          "click",
          {
            index: a,
          },
      ...
      getRecItems: function () {
        if (!this.recItemsId || this.recItemsId.length == 0) return null;
          ...
          for (var a = [], c = [], d = [], f = 0; f < this.recItemsId.length; f++) {
      ...
      getRecOriItems: function () {
        if (!this.recItemsId || this.recItemsId.length == 0) return null;
          ...
          for (var a = [], c = 0; c < this.recItemsId.length; c++) a.push(ea.contacts[this.recItemsId[c]]);
          return a;
        }
      },
    });
    ...
    R.tabs.twitter = {
      ...
      init: function () {
        ...
        a.jMsg = $("#diigolet-dialog-share-twitterMsg").val("").bind("input", $.proxy(a.updateCountDown, a));
      ...
      show: function () {
        ...
        if (!a.shown) {
          ...
          O.send(
            {
              name: "twitterCheckAuthentication",
            },
            function (c) {
      ...
      updateTwitterSignInStatus: function (a) {
        ...
        a && $("#diigolet-dialog-share-twitter-signedIn>span").text(a.screen_name);
      },
      ...
      trySend: function () {
        ...
        O.send(
          ...
          function (c) {
            I(c);
            c && c.id ? L.notifyOK("Your tweet is sent!") : L.notifyAlert("An error has occurred. Your tweet was not sent.");
          }
        );
      },
      ...
      show: function () {
        Ga.get(k.bookmark.url, function () {
          ...
          O.send({
            ...
            details: {
              url:
                "http://www.facebook.com/sharer.php?src=bm&v=4&i=1267884404&" +
                hc({
                  u: k.bookmark.url,
                  t: a,
                }),
        ...
        Ga.get(k.bookmark.url, function (a) {
          O.send({
            ...
            details: {
              ...
              name: "sharer",
              features: "toolbar=1,status=0,resizable=1,scrollbars=1,width=700,height=453",
            },
          });
        });
      },
    ...
    R.tabs.gBuzz_viaGoogleReaderDeprecated = {
      ...
      show: function () {
        ...
        function c(d) {
          ...
          if (d)
            h.snippet += x.AnnotationFormatter.format({
              mode: 1,
            });
          h.snippet += a() + "<br/>";
          if (d)
            h.snippet += Y('<a style="padding-left:2em;" title="#{0}" href="#{1}">#{2}</a><br />', [f, d, "View the annotated version on Diigo"]);
          var i = $('<form action="http://www.google.com/reader/link" method="POST" accept-charset="utf-8"></form>')
            .attr({
              target: "diigolet-GR________link_bookmarklet_frame",
            })
            .appendTo(document.body);
          $.each(h, function (l, m) {
        ...
        this.jframe.attr("src", chrome.extension.getURL("share-gbuzz-loading.html"));
        k.pageComments.length > 0 || k.annotations.length > 0
    ...
    R.tabs.email = {
      ...
      composeMessage: function (a) {
        ...
        a = k.pageComments.length > 0 || k.annotations.length > 0 ? Ga.get(k.bookmark.url) || "DIIGO_PERMALINK" : k.bookmark.url;
        a = Y('<p><a class="diigoAnnotatedLink" href="#{1}" title="#{0}">#{0}</a></p>', [k.bookmark.getTitle(), a]);
        c +=
          '<p><strong>Quotes:</strong></p><blockquote style="border-left: 2px solid #eee; padding-left: 1em; margin-left: 1em;">' +
          a +
          x.AnnotationFormatter.format({
            mode: 1,
    ...
    x.AnnotationFormatter = {
      format: function (a) {
        ...
        var c = (a.mode & 2) == 2,
          d = (a.mode & 1) == 1;
        I("[AnnotationFormatter] format mode:", a.mode, "includeOthers", c, "includePrivate", d);
        var f = "";
        if (a.includePageComments)
          f +=
            ...
            k.pageComments
              .filter(function (h) {
                return (c ? true : h.user == k.user) && (d ? true : h.mode != 2);
              })
              .map(function (h) {
                return '<li style="line-height:150%;margin-bottom:.6em;">' + Ea.string.stripTags(h.content) + "</li>";
              })
              .join("\n") +
            "</ul>";
        f +=
          ...
          k.annotations
            .filter(function (h) {
              return a.onlyPrivate == true ? h.user == k.user && h.onlyInGroup == false : (c ? true : h.user == k.user) && (d ? true : h.mode != 2);
            })
            .map(function (h) {
              var i = "";
              if (h.type == ia) i = Ea.string.stripTags(h.content);
              else if (h.type == Wa) i = Ea.string.evalTpl('<img src="#{0}" title="#{1}" alt="#{1}">(image)', [h.extra.imageUrl, ""]);
              else if (h.type == fa) i = '<img src="https://www.diigo.com/images/v2/float_note.gif" />(floating sticky note)';
              else if (h.type == 3) i = "(flash movie)" + h.content;
              else if (h.type == 4) i = "(video)" + h.content;
              return Ea.string.evalTpl('<li style="line-height:150%;margin-bottom:.6em;">#{0} #{1} #{2}</li>', [
                i,
                h.groups ? "" : "",
                "<ul>" +
                  h.comments
                    .filter(function (l) {
                      return (c ? true : l.user == k.user) && (d ? true : l.mode != 2);
                    })
                    .map(function (l) {
                      return (
                        '<li style="line-height:150%;margin-bottom:.6em;">' +
                        Ea.string.stripTags(l.content) +
                        Ea.string.evalTpl(' <span style="font-size:11px;color:#aaa">comment by <a href="#{0}">#{1}</a></span>', [
                          x.urls.getUserHomepageURL(l.user),
                          l.realName,
                        ]) +
                        "</li>"
                      );
    ...
    R.tabs.annotatedLink = {
      init: function () {
        ...
        this.jInput = $("#diigolet-dialog-share-annotatedLink-value").focus(function () {
          var a = this;
          setTimeout(function () {
            a.select();
          }, 13);
      ...
      show: function () {
        var a = this;
        a.shown = true;
        a.jInput = $("#diigolet-dialog-share-annotatedLink-value").addClass("loading").val(chrome.i18n.getMessage("share_loadingAnnotatedLink"));
        Ga.get(k.bookmark.url, function (c) {
          a.jInput.removeClass("loading").val(c);
          $("#diigolet-dialog-share-annotatedLink-optLinks a:first").attr("href", c);
        });
      },
    };
    var ka = {
      ...
      initSelectedCapture: function () {
        ...
        function d(s) {
          if (s.button == 0) {
            ...
            var w = s.pageX,
              ...
              T = function (P) {
                if ((P.pageX - w == 0 || P.pageY - y == 0) && $("#diigolet_screenshot_center").width() == 0) {
                  h(wrapper, "background-color", "rgba(0,0,0,0)");
                  F.children[0].textContent = Math.abs(200) + " X " + Math.abs(200);
                ...
                h(document.getElementById("diigosc-editpanel"), "display", "block");
                h(F, "display", "block");
                f();
                P = -(195 - C) / 2;
        ...
        function f() {
          var s = $("#diigolet_screenshot_center").offset().top - 30,
            ...
            C = $("#diigolet_screenshot_center").offset().top - document.scrollingElement.scrollTop;
          if (document.scrollingElement.scrollTop + window.innerHeight - $("#diigolet_screenshot_center").offset().top - B > 93) {
            ...
            B = C > 93 ? $("#diigolet_screenshot_center").offset().top - 36 : s + B;
            $("#diigosc-colorpanel").addClass("up");
            $("#diigosc-savepanel").addClass("up");
          }
          y = w + (y - 248);
          h(document.getElementById("diigolet_screenshot_size"), "left", w + "px");
          h(document.getElementById("diigolet_screenshot_size"), "top", s + "px");
        ...
        function m() {
          ...
          dragresize.isElement = function (y) {
            if (y.className && y.className.indexOf("drsElement") > -1) return true;
          };
          dragresize.isHandle = function (y) {
            if (y.className && y.className.indexOf("drsMoveHandle") > -1) return true;
          };
        ...
        if (!($("#diigosc-all").length > 0)) {
          if (!Ma(window.location.href, true))
            if (!/chrome-extension:\/\/.*\/pdf\/viewer.html/.test(window.location.href)) {
              alert(chrome.i18n.getMessage("alertUnsupportedPage"));
              return;
            }
          if (typeof k.permissions.imagePermission !== "undefined" && !k.permissions.imagePermission.imagePermission) {
            ...
            $(".diigosc-editpanel-btn div").bind("click", function (s) {
              function w() {
                $("#diigosc-savepanel").length > 0 && $("#diigosc-savepanel").hide();
              }
              s = s.target.id;
              ...
              switch (s) {
                ...
                case "diigosc-save-btn":
                  $("#diigosc-colorpanel").length > 0 && $("#diigosc-colorpanel").hide();
      ...
      removeSelected: function () {
        document.body.removeEventListener("keydown", this.selectedKeyDown, false);
        this.reInit();
        ...
        function c(t) {
          function D() {
            ...
            $('<input class="diigosc-textinput"></input>')
              ...
              .keydown(function (r) {
                if (($(this).width() + 10 > maxW && r.keyCode >= 48) || (parseInt($(this).css("top")) - startT + 38 > maxH && r.keyCode == 13))
                  return false;
                var n = r.target,
                  u = r.keyCode;
                I(u);
                ...
                if (u == 8)
                  if (!n.value) {
                    $(n).prev().prev().focus().end().end().next().remove().end().remove();
                    q -= 18;
                  }
            ...
            function u() {
              ...
              (function (X) {
                ...
                (function (X, ua, Ha) {
                  ...
                  (function (X, ua) {
                    var Ha = [];
                    for (p in X) Ha.push([X[p][0] * Math.cos(ua) - X[p][1] * Math.sin(ua), X[p][0] * Math.sin(ua) + X[p][1] * Math.cos(ua)]);
                    return Ha;
                  })(
                    [
                      [4, 0],
        ...
        $("#bgcanvas")
          ...
          .mousedown(function (t) {
            if (i.width * i.height != 0) {
              ...
              m.drawImage(i, parseInt($(i).css("left")) - offsetX, parseInt($(i).css("top")) - offsetY);
            } else
              f.actions.length == 0 &&
                f.saveAction({
                  type: "draw",
          ...
          if (d) {
            ...
            c.each(function () {
              ...
              if (f) {
                ...
                l.font = "bold " + a.fontSize + "px/18px Arial,Helvetica,sans-serif";
      ...
      showSavePupop: function (a, c, d) {
        ...
        function i(n, u) {
          if (n == "recommended") $("#diigosc-recommended-tag .diigo-tags-container .loading").hide();
          else if (n == "group") {
        ...
        function m() {
          ...
          $("#diigosc-tag-cloud")
            ...
            .each(function () {
              var s = $(this),
                w = s.text();
              $.inArray(w, u) != -1 ? s.addClass("selected") : s.removeClass("selected");
            });
        ...
        function t(n, u) {
          document.getElementById("diigosc-tag-edit").href = "https://www.diigo.com/cloud/" + k.user;
          if (k.myTagsWithCount.length == 0) {
        ...
        if (a == "screenshot") {
          ...
          if (q.width * q.height != 0) {
            ...
            o.drawImage(q, parseInt($(q).css("left")) - offsetX, parseInt($(q).css("top")) - offsetY);
            $(q).attr({
              width: 0,
              height: 0,
            });
        ...
        $("#diigosc-savepopup").css("top", document.documentElement.scrollTop + "px");
        o = document.documentElement.scrollTop + 150;
        $("#diigosc-savepopup").animate(
          {
            top: o + "px",
            opacity: 1,
          },
          ...
          O.send(
            ...
            function (s) {
              s.preloadedPrefs["prefs.bookmark.privateByDefault"] == "true" &&
                $("#diigosc-privatecheck").find(".op-checkbox-container").addClass("checked");
            }
          );
        ...
        $("#diigosc-title-input")
          .blur(function () {
            $(this).val().length == 0 && $(this).val("Title is needed!").css("color", "red");
          })
          .focus(function () {
            $(this).val() == "Title is needed!" && $(this).val("").css("color", "black");
          });
        $("#diigosc-tag-input")
          .focus(function () {
        ...
        $("#diigosc-lu-tag").click(function () {
          for (var n = $("#diigosc-last-used-tag").find(".diigo-tags-container").find(".diigo-tag"), u = n.length, s = 0; s < u; s++)
            $("#myTags").tagit("createTag", n[s].title);
        });
        $("#diigosc-re-tag").click(function () {
          for (var n = $("#diigosc-recommended-tag").find(".diigo-tags-container").find(".diigo-tag"), u = n.length, s = 0; s < u; s++)
            $("#myTags").tagit("createTag", n[s].title);
        });
        ...
        $("#diigosc-list-addBtn").on("click", function () {
          if (!$(this).hasClass("processing")) {
            ...
            else if ($.inArray(n, s) !== -1) u.show().find("span").text("Name existed !");
            else {
              $(this).addClass("processing");
              z.createList(n);
            }
        ...
        $("#diigosc-saveBtn").click(function () {
          ...
          if (!(n.length == 0 || n == "Title is needed!")) {
            ...
            var B = document.title,
              C = $("#diigosc-privatecheck").find(".op-checkbox-container").hasClass("checked") ? 2 : 0;
            n = {
              dataURL: a == "screenshot" ? $("#diigosc-thumbnail").find("img").attr("src") : c,
              title: n,
              tags: u,
              mode: C,
              src_url: y,
            ...
            I(n);
            a == "screenshot" ? z.uploadImage(n, "capture", false, y, {}, "png", "", false) : z.uploadImage(n, "image", false, y, {}, d, "", false);
            xa(chrome.runtime.id);
            na();
            L.init();
            L.notifyWait(chrome.i18n.getMessage("uploadimage_uploading"), {
      ...
      attachToBookmark: function (a) {
        ...
        if (!a) {
          ...
          if (f.width * f.height != 0) {
            ...
            h.drawImage(f, parseInt($(f).css("left")) - offsetX, parseInt($(f).css("top")) - offsetY);
            $(f).attr({
              width: 0,
              height: 0,
            });
        ...
        chrome.storage.local.get(null, function (t) {
          ...
          if (D) {
          ...
          } else if (typeof DiigoData !== "undefined" && !DiigoData.bookmark.saved)
            diigoNetwork.pdfCreateItem({}, DiigoData, function () {
              ...
              t.researchMode === true && k.bookmark.saved === false
                ? z.uploadImage(l, "capture", false, i, {}, "png", "", true, t.researchModeData)
                : z.uploadImage(l, "capture", false, i, {}, "png", "", true);
            });
          else {
            if (typeof DiigoData !== "undefined") l.src_url = DiigoData.bookmark.server_url;
            t.researchMode === true && k.bookmark.saved === false
              ? z.uploadImage(l, "capture", false, i, {}, "png", "", true, t.researchModeData)
              : z.uploadImage(l, "capture", false, i, {}, "png", "", true);
          }
    ...
    chrome.runtime.onMessage.addListener(function (a) {
      if (a.name == "dataURL") {
        ...
        m.onload = function () {
          ...
          $("#diigolet_screenshot_wrapper>div").css("background-color", "rgba(0,0,0,0.7)");
          var A = i.toDataURL();
          Na({
            type: "init",
            dataUrl: A,
            initTool: ka.initTool,
          });
      ...
      a.fn.autoGrowInput = function (c) {
        ...
        this.filter("input:text").each(function () {
          ...
          a(this).bind("keyup keydown blur update", function () {
            if (f !== (f = h.val())) {
              var l = f.replace(/&/g, "&amp;").replace(/\s/g, "&nbsp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
              i.html(l);
              l = i.width();
      ...
      a.fn.Gtooltip = function (f) {
        ...
        return this.each(function () {
          function i() {
            ...
            C = C.indexOf("macintosh") != -1 || C.indexOf("mac os x") != -1 || C.indexOf("linux") != -1 ? true : false;
            switch (l.position) {
              case "bottom":
                B = C ? -9 : -10;
                s = parseInt((n + 2) / 2);
            ...
            if (l.position == "top") A.css("-webkit-transform", "rotate(180deg)");
            else l.position == "bottom" && A.css("-webkit-transform", "rotate(360deg)");
            t.addClass("show");
          }
          var l = a.extend(h, f || {}),
            m = a(this),
    ...
    (function (a) {
      ...
      function c(h) {
        return !h.nodeName || a.inArray(h.nodeName.toLowerCase(), ["iframe", "#document", "html", "body"]) !== -1;
      }

      function d(h) {
        return a.isFunction(h) || a.isPlainObject(h)
          ? h
          : {
              top: h,
              left: h,
          ...
          if (h !== null) {
            ...
            a.each(l.axis.split(""), function (u, s) {
              ...
              if (r) {
                ...
                o[B] += n[y] || 0;
                if (l.over[y]) o[B] += q[s === "x" ? "width" : "height"]() * l.over[y];
              } else {
                w = q[y];
                o[B] = w.slice && w.slice(-1) === "%" ? (parseFloat(w) / 100) * F : w;
              }
              if (l.limit && /^\d+$/.test(o[B])) o[B] = o[B] <= 0 ? 0 : Math.min(o[B], F);
      ...
      a.Tween.propHooks.scrollLeft = a.Tween.propHooks.scrollTop = {
        ...
        set: function (h) {
          var i = this.get(h);
          if (h.options.interrupt && h._last && h._last !== i) return a(h.elem).stop();
    ...
    (function (a) {
      ...
      a.scrollmarker.fn = a.scrollmarker.prototype = {
        scrollmarker: "0.0.1",
      };
      ...
      a.scrollmarker.fn.extend({
        init: function () {
          ...
          this.marker = a('<div class="diigo-scrollmarker" title="Diigo highlight marker"><div class="inner"></div></div>')
            .attr("id", d)
            .appendTo(a("body"))
            .click(function () {
              c.locate();
          ...
          else this.place.hasClass("pink") ? this.marker.addClass("pink") : this.marker.addClass("yellow");
    ...
    var zb = (function () {
        ...
        a.adjustHeight = function (c, d) {
          ...
          var f = parseFloat(getComputedStyle(c).paddingTop) + parseFloat(getComputedStyle(c).paddingBottom);
      ...
      jc = (function (a) {
        ...
        c.init = function () {
          var d = this;
          d.create();
          d.textarea = document.getElementById("diigolet-highlight-share-textarea");
            ...
            if (d.enable) {
              ...
              if (f === "diigolet-highlight-share-copybtn") {
                ...
                O.send({
                  name: "openWindow",
                  details: {
                    url: "https://twitter.com/intent/tweet?text=" + encodeURIComponent(d.editor.val()) + " @diigo",
                    name: "sharer",
                    features: "toolbar=1,status=0,resizable=1,scrollbars=1,width=700,height=453",
                  },
                });
        ...
        c.show = function (d, f, h) {
          ...
          i.j.addClass("show");
          i.disable();
          z.makeAnnotatedLinkWithHighlight(k.bookmark.url, 3, d.id, function (l) {
        ...
        c.disable = function () {
          this.enabled = false;
          this.j.find("#diigolet-highlight-share-textarea").val("Loading......").prop("disabled", true);
        };
        c.enable = function () {
          this.enabled = true;
          this.j.find("#diigolet-highlight-share-textarea").prop("disabled", false);
        };
        c.hide = function () {
      ...
      Yb = {
        ...
        add: function (a) {
          ...
          c.find(".diigo-orphanHighlight-item-copy").on("click", function () {
            var d = $(this).parent().find(".diigo-orphanHighlight-item-content").text();
            x.Messenger.send({
              name: "copy",
              details: {
                text: d,
            ...
            $("#diigo-orphanHighlight-notification").fadeIn().delay(1e3).fadeOut();
          });
      ...
      aa = {
        ...
        init: function () {
          ...
          $("#diigo-annotationList-copyall").on("click", function (f) {
            ...
            $("#diigo-annotationList-notification").fadeIn().delay(1e3).fadeOut();
          });
          new $.Draggable(a.j, {
            handle: "._dragHandle",
          });
        ...
        add: function (a) {
          ...
          if (a.onlyInGroup == false && a.user == k.user) {
            ...
            if (a.type == ia) {
              ...
              d.find(".diigo-annotationList-item-content").text(ha.html2txt_pretty(a.content));
              console.log(ha.html2txt_pretty(a.content));
              if (this.isOrphanHighlight(a)) {
                d.addClass("diigo-orphan");
                d.append('<div class="diigo-annotationList-orphan-warning"></div>');
              }
              if (a.comments.length) {
                var f = d.find(".diigo-annotationList-commentContainer");
                a.comments.forEach(function (i) {
                  $('<div class="diigo-annotationList-commentItem" data-cid="' + i.id + '">' + i.content + "</div>").appendTo(f);
                });
                d.append(f);
              }
              d.appendTo($("#diigo-annotationList-box"));
              d.find(".diigo-annotationList-item-copy").on("click", function (i) {
                i.stopPropagation();
                var l = $(this).parent().parent().find(".diigo-annotationList-item-content").text();
                $(this)
                  .parent()
                  .parent()
              ...
              var h = this;
              d.find(".diigo-annotationList-item-delete").on("click", function (i) {
                i.stopPropagation();
                if (!a.onlyInGroup) {
                  N.find(a.id) ? N.find(a.id).del() : h.editItem("remove", a);
                  document.getElementById("diigo-reader-frame").contentWindow.postMessage(
                    {
              ...
              d.find(".diigo-annotationList-item-content").html($("<div>").text(a.comments[0].content).html());
              d.appendTo($("#diigo-annotationList-box"));
              d.find(".diigo-annotationList-item-copy").on("click", function (i) {
                i.stopPropagation();
                i = $(this).parent().find(".diigo-annotationList-item-content").text();
                x.Messenger.send({
                  name: "copy",
                  details: {
                    text: i,
        ...
        updatecontent: function () {
          $("#diigo-annotationList-box").find(".diigo-annotationList-item").length === 0 &&
          ...
          $("#diigo-annotationList-toolbar").toggle($("#diigo-annotationList-box").find(".diigo-annotationList-item").length > 0);
        },
        hide: function () {
          this.j.hide();
          this.shown = false;
        ...
        editItem: function (a, c, d) {
          if (this.j) {
            var f = c ? this.j.find('[data-ann-id="' + c.id + '"]') : this.j.find('[data-ann-id="' + d.annotationId + '"]');
            if (f && f.length > 0)
              switch (a) {
                case "remove":
                  f.remove();
                  $("#diigo-annotationList-box").find(".diigo-annotationList-item").length === 0 && this.updatecontent();
                  break;
                case "changeColor":
                  f.removeClass("diigo-yellow diigo-blue diigo-green diigo-pink").addClass("diigo-" + c.extra.color);
                  break;
                case "updateStickyNote":
                  c = N.find(d.annotationId);
                  a = c.type;
                  if (a == ia) f.find(".diigo-annotationList-commentItem").text(d.content);
                  else a == fa && f.find(".diigo-annotationList-item-content").text(d.content);
                  break;
                case "addInlineComment":
                  $("#diigo-annotationList-noItem").remove();
                  $('<div class="diigo-annotationList-commentItem" data-cid="' + d.id + '">' + d.content + "</div>").appendTo(
                    f.find(".diigo-annotationList-commentContainer")
                  );
                  break;
                case "delInlineComment":
                  f.find(".diigo-annotationList-commentContainer")
                    .find('.diigo-annotationList-commentItem[data-cid="' + d.id + '"]')
                    .remove();
                  break;
                default:
              }
        ...
        K.get("prefs.showPdfButton", function (a) {
          if (a === "true") {
            ...
            $("embed").bind("click", function () {
              document.body.scrollTop == 0 ? $("#diigo-enter-pdf").show() : $("#diigo-pdf").hide();
            });
    ...
    var lc = {
        ...
        init: function () {
          var a = this;
          this.j = $(
            '<div id="diigo-ext-tutorial-wrapper" class="step1"><div id="diigo-ext-tutorial-panel"><div id="diigo-ext-tutorial-banner"><div id="diigo-ext-tutorial-elem1"></div><div id="diigo-ext-tutorial-elem2"></div><div id="diigo-ext-tutorial-elem3"></div><div id="diigo-ext-tutorial-banner-text"><span>Congratulations!</span><div>You are on the path to better learning.</div></div></div><div id="diigo-ext-tutorial-container"><div class="diigo-ext-tutorial-slide diigo-ext-tutorial-1 active"><div class="left"><div id="diigo-tutorial-image1"></div></div><div class="right"><div style="height: 212px; margin-top: 22px;"><div style="position: relative; top: 85px;">Found a link you like? Keep it by selecting "Save" at the top right of our extension menu.</div></div><div style="height: 212px; margin-top: 22px;"><div style="position: relative; top: 70px;">Add a description and reference with tags for easy future retrieval.</div></div></div></div><div class="diigo-ext-tutorial-slide diigo-ext-tutorial-2"><div class="left"><div id="diigo-tutorial-image2"></div></div><div class="right"><div style="height: 212px; margin-top: 22px;"><div style="position: relative; top: 85px;">Capture images you want to keep or share by selecting the "Screenshot" option in our extension menu.</div></div><div style="height: 212px; margin-top: 22px;"><div style="position: relative; top: 50px;">Then select the portion of the page you want to capture. You will have the option of adding text, arrows, squares, etc. You can also label your images with tags to find them later on.</div></div></div></div><div class="diigo-ext-tutorial-slide diigo-ext-tutorial-3"><div class="left"><div id="diigo-tutorial-image3"></div></div><div class="right"><div style="height: 312px; margin-top: 75px;"><div style="position: relative; top: 85px;">Highlight important or interesting parts of any website directly on the page. You can also add sticky notes directly to the page to mark important sections or reminders.</div></div></div></div><div class="diigo-ext-tutorial-slide diigo-ext-tutorial-4"><div class="left"><div id="diigo-tutorial-image4"></div></div><div class="right"><div style="height: 312px; margin-top: 83px;"><div style="position: relative; top: 103px;">Once you have enough saved links with similar tags, you can structure your links through Outliner. This is the most efficient way to organize your links and share them with friends, classmates, or colleagues.</div></div></div></div></div><a href="#" id="diigo-ext-tutorial-next" class="diigo-ext-tutorial-btn"></a><a href="#" id="diigo-ext-tutorial-prev" class="diigo-ext-tutorial-btn"></a><a href="#" id="diigo-ext-tutorial-close" class="diigo-ext-tutorial-btn"></a></div></div>\n'
          ).appendTo($("body"));
      ...
      Xb = {
        ...
        init: function () {
          ...
          this.j.find("#diigo-ghost").on("dragover", function (c) {
            ...
            a.j.find("#diigo-reader-frame")[0].contentWindow.postMessage(
              {
                type: "event",
                data: {
                  e: c.originalEvent,
          ...
          window.addEventListener("message", function (c) {
            ...
            if (c.type == "processStart") {
              ...
              c = {
                ...
                pathBase: c.protocol + "//" + c.host + c.pathname.substr(0, c.pathname.lastIndexOf("/") + 1),
              };
              a.j.find("#diigo-reader-frame")[0].contentWindow.postMessage(
                {
                  type: "doc_html",
        ...
        open: function () {
          ...
          setTimeout(function () {
            a.j.find("#diigo-reader-frame").attr("src", chrome.extension.getURL("") + "reader.html");
          }, 300);
        },
        ...
        init: function () {
          ...
          this.j
            ...
            .on("drop", function (c) {
              ...
              if (c.originalEvent.dataTransfer.getData("text/html") && $(c.originalEvent.dataTransfer.getData("text/html"))[0].tagName === "IMG") {
                d.imgSrc = $(c.originalEvent.dataTransfer.getData("text/html")).attr("src");
                d.title = document.title;
                d.originSrc = window.location.href;
              } else if (
                c.originalEvent.dataTransfer.getData("text/html") &&
                $(c.originalEvent.dataTransfer.getData("text/html"))[0].tagName == "META"
              )
                if ($(c.originalEvent.dataTransfer.getData("text/html"))[1].tagName == "IMG") {
                  d.imgSrc = $(c.originalEvent.dataTransfer.getData("text/html"))[1].src;
                  d.title = document.title;
                  d.originSrc = window.location.href;
                }
          ...
          window.addEventListener("message", function (c) {
            ...
            else c.data.type == "outliner" && a.j.find("iframe").attr("src", c.data.url);
          });
          this.detectCSP();
        },
        detectCSP: function () {
          ...
          a.setAttribute("src", "https://www.diigo.com/asset/images/logo_s2.png");
          ...
          setTimeout(function () {
            a.j.find("#diigo-outliner-iframe").attr("src") == "" &&
              K.get("prefs.outlinerFrameUrl", function (c) {
                ...
                } else if (c == "https://www.diigo.com/outliner/index") c += "?csp=true";
      ...
      za = {
        j: null,
        init: function () {
          this.j = $('<iframe id="diigo-bookmark-frame"></iframe>').appendTo("body").hide();
        },
        show: function (a, c) {
          this.j || this.init();
