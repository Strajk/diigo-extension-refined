      ...
      _showResult: function (c) {
        ...
        chrome.runtime.sendMessage(
          ...
          function (a) {
            if (a == true) {
              ...
              (d = document.getElementById("diigoComboSearch-main")) && d.appendChild(a);
        ...
        $("#diigoComboSearch")
          ...
          .on("click", ".diigo-tag", function (a) {
            ...
            a = a.target;
            a =
              "https://www.diigo.com/search?adSScope=my&what=%23" + (/\s/.test($(a).text()) ? '"' + $(a).text() + '"' : $(a).text()) + "&snapshot=no";
            window.open(a);
          });
        ...
        $("#diigoComboSearch-close-action").on("click", "li", function () {
          if ($(this).hasClass("diigoComboSearch-close-t")) $("#diigoComboSearch").hide();
          else if ($(this).hasClass("diigoComboSearch-close-f")) {
            $("#diigoComboSearch").hide();
            chrome.runtime.sendMessage({
              name: "closeComboSearch",
            });
          }
        });
      },
