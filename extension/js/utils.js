...
Utils.lang = {
  ...
  extend: function () {
    for (var a = [].slice.call(arguments), b = a.shift(), g = 0, i = a.length, j; (j = a[g]), g < i; g++) for (var k in j) b[k] = j[k];
    return b;
  },
  ...
  extendFiltered: function () {
    for (var a = [].slice.call(arguments), b = a.shift(), g = a.pop(), i = 0, j = a.length, k; (k = a[i]), i < j; i++)
      for (var q in k) {
        var h = g(q);
...
Utils.array = {
  ...
  reverse: function (a) {
    for (var b = Array(a.length), g = a.length - 1, i = 0; g >= 0; g--, i++) b[i] = a[g];
    return b;
  },
};
Utils.string = {
  md5: function (a) {
    function b(l, m) {
      ...
      return o | r ? (n & 1073741824 ? n ^ 3221225472 ^ s ^ p : n ^ 1073741824 ^ s ^ p) : n ^ s ^ p;
    }
    ...
    h = (function (l) {
      var m,
        o = l.length;
      m = o + 8;
      for (var r = ((m - (m % 64)) / 64 + 1) * 16, s = Array(r - 1), p = 0, n = 0; n < o; ) {
        m = (n - (n % 4)) / 4;
        p = (n % 4) * 8;
  ...
  toQueryString: function (a) {
    var b = function (i, j) {
        ...
        j === undefined ? g.push(i) : g.push(i + "=" + (j == null ? "" : encodeURIComponent(j)));
      },
      g = [];
...
function isHomePage() {
  ...
  return (a = a.match(/^\/([^\.]+)\.(.*)$/)) && a.length == 3
    ? $.inArray(a[1], ["default", "index", "home"]) > -1 && $.inArray(a[2], ["htm", "html", "shtml", "php", "jsp", "asp", "aspx", "cfm"]) > -1
    : false;
}
