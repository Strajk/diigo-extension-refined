...
Readability.prototype = {
  ...
  _getClassWeight: function (e) {
    ...
    if (typeof e.className === "string" && e.className !== "") {
      ...
      if (this.REGEXPS.positive.test(e.className) || (this._hasAncestorTag(e, "figure") && /is-imageLoaded/.test(e.className))) weight += 25;
    }
  ...
  _clean: function (e, tag) {
    ...
    this._removeNodes(e.getElementsByTagName(tag), function (element) {
      ...
      if (isEmbed) {
        ...
        if (tag == "img") {
          if (
            !/progressiveMedia-thumbnail js-progressiveMedia-thumbnail/.test(element.className) &&
            !/progressiveMedia-zoom js-progressiveMedia-inner/.test(element.className)
          ) {
            return false;
          }
        } else if (tag == "canvas") {
