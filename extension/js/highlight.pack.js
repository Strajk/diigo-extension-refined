(function (a) {
        ...
        for (var h = j.firstChild; h; h = h.nextSibling)
          3 === h.nodeType
            ...
            : 1 === h.nodeType &&
              ...
              (b = f(h, b)),
              h.nodeName.toLowerCase().match(/br|hr|img|input/) ||
                g.push({
                  event: "stop",
                  offset: b,
                  node: h,
  ...
  function r(d) {
    ...
    function f(b, h) {
      return RegExp(g(b), "m" + (d.cI ? "i" : "") + (h ? "g" : ""));
    }
    ...
    function j(b, h) {
      if (!b.compiled) {
        ...
        b.lR = f(b.l || /\w+/, true);
        h &&
          (b.bK && (b.b = "\\b(" + b.bK.split(" ").join("|") + ")\\b"),
          b.b || (b.b = /\B|\b/),
          (b.bR = f(b.b)),
          b.e || b.eW || (b.e = /\B|\b/),
          b.e && (b.eR = f(b.e)),
          (b.tE = g(b.e) || ""),
          b.eW && h.tE && (b.tE += (b.e ? "|" : "") + h.tE));
        b.i && (b.iR = f(b.i));
        null == b.r && (b.r = 1);
        b.c || (b.c = []);
        var y = [];
  ...
  function w(d, g, f, j) {
    ...
    function v() {
      var p = q,
        k;
      if (null != e.sL)
        if ((k = "string" == typeof e.sL) && !C[e.sL]) k = c(s);
        else {
    ...
    function y(p, k) {
      ...
      if ((l = b(e, k))) {
        n = e;
        n.skip ? (s += k) : (n.rE || n.eE || (s += k), v(), n.eE && (s = k));
        do {
          e.cN && (q += K);
          e.skip || (I += e.r);
          e = e.parent;
  ...
  function D(d, g) {
    ...
    var f = {
      ...
      j = f;
    return (
      g.filter(E).forEach(function (b) {
        var h = w(b, d, false);
        h.language = b;
        h.r > j.r && (j = h);
        h.r > f.r && ((j = f), (f = h));
      }),
      j.language && (f.second_best = j),
      f
    );
  }
  ...
  function P(d) {
    return A.tabReplace || A.useBR
      ? d.replace(T, function (g, f) {
          return A.useBR && "\n" === g ? "<br>" : A.tabReplace ? f.replace(/\t/g, A.tabReplace) : void 0;
        })
      : d;
  }
  ...
  function Q(d) {
    ...
    a: {
      var v;
      h = d.className + " ";
      if (((h += d.parentNode ? d.parentNode.className : ""), (b = U.exec(h)))) h = E(b[1]) ? b[1] : "no-highlight";
      else {
        h = h.split(/\s+/);
        b = 0;
        for (v = h.length; v > b; b++)
          if (((f = h[b]), R.test(f) || E(f))) {
            h = f;
            break a;
          }
        h = void 0;
    ...
    if (!R.test(h)) {
      A.useBR
        ? ((g = document.createElementNS("http://www.w3.org/1999/xhtml", "div")),
          (g.innerHTML = d.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n")))
        : (g = d);
      b = g.textContent;
      f = h ? w(h, b, true) : D(b);
      g = o(g);
      g.length && ((j = document.createElementNS("http://www.w3.org/1999/xhtml", "div")), (j.innerHTML = f.value), (f.value = x(g, o(j), b)));
      f.value = P(f.value);
      d.innerHTML = f.value;
      j = d.className;
      g = h ? M[h] : f.language;
  ...
  function E(d) {
    return (d = (d || "").toLowerCase()), C[d] || C[M[d]];
  }
  var N = [],
    J = Object.keys,
    C = {},
  ...
  return (
    ...
    (a.UIR = "[a-zA-Z_]\\w*"),
    (a.NR = "\\b\\d+(\\.\\d+)?"),
    (a.CNR = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)"),
    (a.BNR = "\\b(0b[01]+)"),
    (a.RSR =
      "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~"),
    (a.BE = {
...
hljs.registerLanguage("objectivec", function (a) {
  ...
  return {
    ...
    c: [
      ...
      {
        cN: "class",
        b: "(" + "@interface @class @protocol @implementation".split(" ").join("|") + ")\\b",
        e: "({|$)",
        eE: true,
