...
$(document).ready(function () {
  function n(e) {
    ...
    function l() {
      ...
      var b = a.find(".menu-item:visible").eq(d),
        h = b.offset().top + c.scrollTop() - c.offset().top;
      b = b.outerHeight();
      if (h + b > c.outerHeight() + c.scrollTop()) c.scrollTop(h + b - c.outerHeight());
      else h < c.scrollTop() && c.scrollTop(h);
    }
    ...
    var a = $(e),
      f = a.find(".content"),
      i = a.find(".search-box input"),
      j = a.find(".search-box"),
      c = a.find(".item-container"),
      k = a.find(".add-box"),
      o = a.find(".remove-select"),
      d = -1;
    ...
    i.on("input", function () {
      ...
      a.find(".menu-item").each(function () {
        $(this).text().toLowerCase().indexOf(b) == -1 ? $(this).hide() : $(this).show();
        m();
      });
