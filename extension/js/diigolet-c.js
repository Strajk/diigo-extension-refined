    ...
    x.handlers = {
      ...
      diigoFacebook: function () {
        if (da()) {
          ...
          k.permalinkURL && k.permalinkURL.length > 0
            ? window.open(
                "https://www.facebook.com/sharer.php?u=" + encodeURIComponent(a.url) + "&t=" + encodeURIComponent(a.getTitle()),
                "sharer",
                "toolbar=0,status=0,width=626,height=436,chrome=yes,centerscreen"
              )
            : window.open("https://www.facebook.com/sharer.php", "sharer", "toolbar=0,status=0,width=626,height=436,chrome=yes,centerscreen");
        }
      },
    ...
    var Y = {
        ...
        create: function () {
          ...
          $("#diigolet-csm-search").click(function () {
            ...
            window.open("https://www.diigo.com/search/g?q=" + encodeURIComponent(h) + "&sa=Search");
            return false;
          });
          ...
          $.map(
            ...
            function (h) {
              ...
              if (h.type == diigolet.consts.ANNOTATION_TYPE_TEXT) i = A.string.stripTags(h.content);
                ...
                i = '<img src="https://www.diigo.com/images/v2/float_note.gif" />(floating sticky note)';
