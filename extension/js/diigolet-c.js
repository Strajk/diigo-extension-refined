if (window.diigolet == undefined) {
  ...
  try {
    (function () {
      ...
      var ta = [Array.prototype, ["slice", "push", "indexOf"], String.prototype, ["trim"]],
        la,
        ha,
        N,
        Aa,
  ...
  (function () {
    function wa(a, c) {
      try {
        Na.indexOf(c) >= Na.indexOf(x.logLevel) && window.console && console.log.apply(console, a);
      } catch (d) {}
    }
    ...
    function Ua(a) {
      ...
      for (c = ""; d < f; ) {
        ...
        if (d == f) {
          c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h >> 2);
          c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((h & 3) << 4);
          c += "==";
          break;
        }
        i = a.charCodeAt(d++);
        if (d == f) {
          c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h >> 2);
          c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(((h & 3) << 4) | ((i & 240) >> 4));
          c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((i & 15) << 2);
          c += "=";
          break;
        }
        m = a.charCodeAt(d++);
        c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h >> 2);
        c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(((h & 3) << 4) | ((i & 240) >> 4));
        c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(((i & 15) << 2) | ((m & 192) >> 6));
        c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(m & 63);
      }
      return c;
    }
    ...
    function qa(a) {
      function c(t, s) {
        ...
        return u | E ? (F & 1073741824 ? F ^ 3221225472 ^ G ^ D : F ^ 1073741824 ^ G ^ D) : F ^ G ^ D;
      }
      ...
      l = (function (t) {
        var s,
          u = t.length;
        s = u + 8;
        for (var E = ((s - (s % 64)) / 64 + 1) * 16, G = Array(E - 1), D = 0, F = 0; F < u; ) {
          s = (F - (F % 4)) / 4;
          D = (F % 4) * 8;
    ...
    function Wa() {
      ...
      typeof document.addEventListener === "undefined" || typeof a === "undefined" || document.addEventListener(c, Va, false);
    }
    ...
    function eb() {
      ...
      Fa.mousedown(function (a) {
        if (a.target.tagName == "INPUT" || a.target.tagName == "TEXTAREA") Ga = true;
        else if (
    ...
    function ib(a, c) {
      if (!k.draggingFloatNote) {
        ...
        if (d) {
          ...
          if (c != null) {
            c.activate(true);
            if (d.type == diigolet.consts.ANNOTATION_TYPE_TEXT || d.type == diigolet.consts.ANNOTATION_TYPE_IMAGE) {
              Z.reset(c);
              P.scheduleShow(a, c);
            }
            if (c.comments.length > 0 && (d.type == diigolet.consts.ANNOTATION_TYPE_TEXT || d.type == diigolet.consts.ANNOTATION_TYPE_IMAGE)) {
              Z.reset(c);
    ...
    function gb(a, c) {
      if (!k.draggingFloatNote) {
        ...
        if (d) {
          ...
          } else if (d.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE || d.type == diigolet.consts.ANNOTATION_TYPE_ICON) {
            Z.removeEditMode();
            Z.ann = null;
            var f = B.ann != c;
            if (!B.isEditing())
    ...
    function fb(a) {
      ...
      H.clickedOn = R.clickedOn = lb.clickedOn = B.clickedOn = U.clickedOn = Ga = ya = false;
    }
      ...
      for (var d = "", f, h, i = /([^{}@]*)(\{[^{}]*\})/g; (f = i.exec(Ha)); ) {
        ...
        d +=
          $.map(h.split(","), function (m) {
            if (/(^|\s)body([\s.\[#]|$)/.test(m)) return m.replace("body", "body#" + a);
            if (/(^|\s)html(\s|$)/.test(m)) return m.replace("html", "html body#" + a);
    ...
    $.browser.supportPositionFixed = !$.browser.msie || ($.browser.version >= 7 && $.support.boxModel);
    ...
    (function (a) {
      var c = false;
      try {
        if (JSON && JSON.parse && JSON.stringify && JSON.parse('{"a":1}').a === 1 && JSON.stringify([1]) == '"[1]"') c = true;
      } catch (d) {}
      a.toJSON = function (i) {
        var m = typeof i;
        ...
        if (m != "undefined") {
          ...
          if (m == "object") {
            ...
            if (i.constructor === Date) {
              ...
              if (i < 100) i = "0" + i;
              if (i < 10) i = "0" + i;
              return '"' + r + "-" + l + "-" + m + "T" + y + ":" + z + ":" + w + "." + i + 'Z"';
            }
            m = [];
            for (l in i) if (Object.hasOwnProperty.call(i, l)) (r = a.toJSON(i[l])) && m.push(a.quoteString(l) + ":" + r);
            return "{" + m.join(", ") + "}";
          }
        }
      };
        ...
        if (i.match(f))
          return (
            ...
            i.replace(f, function (m) {
              ...
              l = m.charCodeAt();
              return "\\u00" + Math.floor(l / 16).toString(16) + (l % 16).toString(16);
            }) +
            '"'
          );
        return '"' + i + '"';
    ...
    var Sa = /(^|.|\r|\n)(#\{(.*?)\})/,
      ob = {
        mixin: function (a) {
          ga(a, this, ca("addEventListener removeEventListener fireEvent _resetEvents"));
          a._resetEvents();
        },
    ...
    T.prototype = {
      extend: function (a, c) {
        if (arguments.length > 1) {
          ...
          if (!T._prototyping && typeof this != "function") h = this.extend || h;
          for (
            var i = {
                toSource: null,
              },
    ...
    var kb = function (a, c) {
              ...
              z = setTimeout(function () {
                if (y.val().length < w.minChars) o.hide();
                  ...
                  a: {
                    ...
                    q = [];
                    t = 0;
                    for (var s; (s = w.data[t]), t < w.data.length; t++) s.toLowerCase().indexOf(n) == 0 && q.push(s);
                    l(n, q);
                  }
              }, w.delay);
              break;
        ...
        function l(p, n) {
          if (n && n.length > 0) {
            ...
            var q = (function (t) {
              for (var s = t.offsetLeft || 0, u = t.offsetTop || 0; (t = t.offsetParent); ) {
                s += t.offsetLeft;
                u += t.offsetTop;
              }
              if ($.browser.opera && document.compatMode != "CSS1Compat") u += 30;
              return {
                x: s + 0,
                y: u + 0,
              };
        ...
        if (typeof w.multipleSeparator == "string") w.multipleSeparator = w.multipleSeparator.split("");
        this.destroy = function () {
          y.unbind("keydown", h).unbind("blur", r);
          $(window).unbind("scroll", f);
          y[0].autoCompleter = null;
        };
        y.attr("autocomplete", "off").addClass(w.inputClass).bind("keydown", h).bind("blur", r);
    ...
    diigolet.consts = {
      ...
      MSG_HIGHLIGHT_NOT_FOUND: "No corresponding text is found on the page. This page has probably been changed since you highlighted it.",
      MSG_HIGHLIGHT_TOO_LONG: "Too many words in one highlight.",
      MSG_COMMENT_TOO_LONG: "Too many words in one comment.",
      MSG_UPLOADING: "Uploading this page to Diigo. You can continue with your browsing.",
      DIIGO_SERVER: "https://www.diigo.com",
      DIIGO_DATA_SERVER: "https://toolbar3.diigo.com",
      DIIGO_GROUP_SERVER: "http://groups.diigo.com",
    ...
    x.handlers = {
      ...
      tb_signIn: function (a) {
        if ($.browser.chrome && typeof document.webkitHidden != "undefined") return false;
        else if ($.browser.mozilla && typeof document.mozHidden != "undefined") return false;
        a.stopPropagation();
        a.preventDefault();
      ...
      readlater: function () {
        if (da())
          if (k.bookmark.unread == true) H.notify("This page has already been put into Reading List.", 2e3);
          else {
      ...
      dropDownColorMenu: function () {
        ...
        k.penColor && k.penColor.length > 0
          ? K("diigolet-colorMenu-" + k.penColor).toggleClass("colorchecked", true)
      ...
      sharetoTwitter: function (a) {
        var c = k.bookmark;
        k.permalinkURL.length <= 0 && (k.pageComments.length > 0 || k.annotations.length > 0)
      ...
      diigoFacebook: function () {
        if (da()) {
          ...
          k.permalinkURL && k.permalinkURL.length > 0
            ? window.open(
                "http://www.facebook.com/sharer.php?u=" + encodeURIComponent(a.url) + "&t=" + encodeURIComponent(a.getTitle()),
                "sharer",
                "toolbar=0,status=0,width=626,height=436,chrome=yes,centerscreen"
              )
            : window.open("http://www.facebook.com/sharer.php", "sharer", "toolbar=0,status=0,width=626,height=436,chrome=yes,centerscreen");
        }
      },
      ...
      uploadCache: function () {
        ...
        C.uploadCacheCheckbf(a, 2, function (c) {
          ...
          if (c.code == 2) H.notify("Upload Succeeded", 5e3, 2);
            ...
            c.code == 0
              ? H.notify(c.msg && c.msg.length > 0 ? c.msg : "Your upload failed. Please try again later.", 1e4, 3)
    ...
    var ya = false,
      ...
      k = (window.Ctx = {
        ...
        toggleSilent: function (a) {
          ...
          if (a != this.silent) (this.silent = a) ? this.unpaintAllAnnotations() : this.paintAllAnnotations();
        },
        launchMode: {
        ...
        getMIMEType: function () {
          ...
          if (a) if ((a = a.getAttribute("content")) && a.indexOf("text/html") >= 0) return "text/html";
          return "";
        },
        reset: function () {
          this.resetData();
        ...
        paintAllAnnotations: function () {
          function a(h) {
            for (var i = window.location.search.substring(1).split("&"), m = 0; m < i.length; m++) {
              var l = i[m].split("=");
              if (l[0] == h) return l[1];
            }
            return false;
          ...
          for (var c = $(".diigoHighlight"), d = [], f = 0; f < c.length; f++) d[f] = c[f].className.match(/id(\w)+/g)[0];
          c = la(d);
    ...
    x.run = function () {
      ...
      window.diigoSourceHtml = a
        .replace(/<script[^>]*src=[^>]*[(diigolet.js)(diigolet_b_h_)][^>]*>([\\S\\s]*?)<\/script>/g, "")
      ...
      $.browser.ieBelow7 && document.execCommand("BackgroundImageCache", false, true);
      C.loadBookmark();
      eb();
      !window.__diigolet_hidden && !k.launchMode.cachePage && H.show();
      k.launchMode.threeDForum && $("#diigolet-tb-content,#diigolet-tb-shadow").hide();
      U.adjustPosition();
    ...
    var $a = {
      ...
      parseTags: function (a, c) {
        ...
        for (var f = [], h = [], i = false, m = 0, l = a.length, r; (r = a.charAt(m)), m < l; m++)
          if (r == '"')
            if (i) {
              i = false;
              d();
    ...
    var I = T.extend({
      ...
      getPageOffset: function () {
        ...
        a =
          this.type == diigolet.consts.ANNOTATION_TYPE_TEXT
            ...
            : $("." + L.HIGHLIGHT_TYPE_CLASS + this.type + "." + L.HIGHLIGHT_ID_CLASS + this.id);
        if (a.size() <= 0)
          return {
            left: 0,
            top: 0,
      ...
      jumpHere: function (a, c, d) {
        ...
        if (this.paintedSuccessfully) {
          var f = this.type == diigolet.consts.ANNOTATION_TYPE_TEXT ? $("em." + S.HIGHLIGHT_ID_CLASS + this.id) : this.getEle();
          if (f.size() == 0) H.notify(diigolet.consts.MSG_HIGHLIGHT_NOT_FOUND);
            ...
            e = d
              ? {
                  pageX: d.pageX,
                  pageY: d.pageY + f.height(),
                }
              : {
                  pageX: h.left,
                  pageY: h.top + f.height() + 15,
                };
            B.hide();
            if (c || this.comments.length > 0) B.show(e, this, c ? "add" : "view");
          }
    ...
    M(Ia, {
      paint: function (a) {
        a = I.find(a);
        (a.mode == diigolet.consts.PRIVACY_MODE_PUBLIC && a.groups.length <= 0) || Ba.paint(a);
      },
      unpaint: function (a) {
        a = I.find(a);
        Ba.unpaint(a);
    ...
    var ba = I.extend({
      constructor: function (a) {
        ...
        if (!this.extra.imageUrl) this.extra.imageUrl = ba.makeAbsUrl((this.content.match(/<img.*?\s+src=['"]?(.*?)['"]?[\s>]/im) || [])[1] || "", a);
      ...
      getEle: function () {
        ...
        if (a.size() == 0)
          for (
            ...
            if (l.src.indexOf(c) > -1 && d == ba.makeAbsUrl(l.src, k.bookmark.url)) {
              h++;
      ...
      paint: function (a) {
        function c(i, m) {
          $(i)
            ...
            .addClass(L.HIGHLIGHT_TYPE_CLASS + diigolet.consts.ANNOTATION_TYPE_ICON)
            .addClass("ImageIcon")
        ...
        a = I.find(a);
        if (!(a.mode == diigolet.consts.PRIVACY_MODE_PUBLIC && a.groups.length <= 0)) {
          var d = a.getEle();
          if (d) {
            var f = a.comments;
            ...
            if (a.type == diigolet.consts.ANNOTATION_TYPE_IMAGE && $("div." + L.HIGHLIGHT_ID_CLASS + a.id).size() <= 0 && d.size() > 0) {
    ...
    var Ja = I.extend({
      constructor: function (a) {
        ...
        this.base(a);
        this.saving = false;
        if (!this.id) this.id = qa(Math.random() + Math.random() + new Date().getTime().toString());
      ...
      paint: function (a) {
        ...
        if (a.painted) {
          ...
          if (c) {
            ...
            setTimeout(function () {
              (B.getCommentCount("group", a.comments) || "") > 0 && c.find("span").text(B.getCommentCount("group", a.comments)).show();
            }, 100);
          }
        } else {
        ...
        addGroups: function (a) {
          ...
          J(a, function (d) {
            if (
              ...
              c.groups.push(d);
              k.fireEvent((c instanceof ja ? "pc" : "ic") + "_add", [c, d.name]);
            }
          });
        },
      }),
    ...
    M(ea, {
      add: function (a) {
        ...
        if (ann.getComments("_noGroups").length > 0) {
          if (a.mode != ann.mode && a.mode != diigolet.consts.PRIVACY_MODE_GROUP) a.mode = ann.mode;
        } else if (a.mode != ann.mode && a.mode != diigolet.consts.PRIVACY_MODE_GROUP) {
          ann.mode = a.mode;
      ...
      del: function (a, c) {
        ...
        if (a.onlyInGroup && a.groups.length == 0) {
          ...
          if (h.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && d.length == 0)
            var i = function () {
              h.del(c);
            };
        }
    ...
    J([ma, I, Ca], function (a) {
      a.implement({
        isPublic: function () {
          return this.mode == diigolet.consts.PRIVACY_MODE_PUBLIC && !this.onlyInGroup;
        },
        isPrivate: function () {
          return this.mode == diigolet.consts.PRIVACY_MODE_PRIVATE && !this.onlyInGroup;
        },
    ...
    var C = {
        ...
        callback: function (a) {
          ...
          } else k.signedIn && !a.user && !a.batch_id && !k.launchMode.cachePage && Ya();
          if (d) {
            if (d == "user_loadMyStuff") a.result.user = a.user;
            this["cb_" + d] && this["cb_" + d](a);
            a.code == 1 && this["cb_" + d + "_success"] && this["cb_" + d + "_success"](a.result);
            a.code == 0 && this["cb_" + d + "_failure"] && this["cb_" + d + "_failure"](a.result);
          }
          ...
          if (a.code != 1) {
            ...
            H.updateUsername();
          } else (d && !oa(["bm_saveBookmark", "annotation_add", "pc_add", "ic_add"], d)) || H.updateUsername();
        },
        invoke: function (a, c, d) {
          ...
          if (a == "user_signIn")
            c = Q(diigolet.consts.DIIGO_DATA_SERVER + "/chappai/pv=#{pv}/ct=tb/cv=#{cv}/cmd=#{cmd}", {
              pv: 13,
              cv: x.version,
              cmd: a,
            });
            ...
            if (k.user == "") k.user = _DIIGO_CACHE.originUser;
            c = Q(diigolet.consts.DIIGO_DATA_SERVER + "/chappai/pv=#{pv}/ct=tb/cv=#{cv}/user=#{user}/cmd=#{cmd}/", {
              pv: 13,
              cv: x.version,
              user: k.user,
              cmd: a,
        ...
        performInvocation: function (a, c, d, f) {
          ...
          h.xhr = $.ajax({
            ...
            complete: function (i) {
              ...
              if (f == "upload_file" || f == "bm_saveBookmark" || f == "list_create") {
                h.status = i.status;
                h.cmd = f;
              }
        ...
        invokeUpload: function (a, c) {
          ...
          if (d.length > ($.browser.msie ? 2e3 : 4e3)) H.notify("Too many words you inputted.");
          else {
            f.src = a;
        ...
        uploadImage: function (a, c, d, f, h, i, m) {
          ...
          chrome.extension.getBackgroundPage().Messenger.handlers.WebAPI(
            {
              details: a,
            },
            {},
        ...
        cb_bm_loadBookmark_success: function (a) {
          ...
          c.saved && a.bookmarkInfo && ga(c, a.bookmarkInfo, ca("title mode tags unread alert description datetime onlyInGroup lists"));
            ...
            J(a.annotations, function (d) {
              var f = I.add(
                ga(
                  ...
                  d,
                  ca("id user realName mode type content datetime extra groups onlyInGroup")
                ),
                {
                  dontPaint: true,
                  dontSort: true,
        ...
        addAnnotation: function (a) {
          var c = {
            ...
            type: a.type,
            extra: a.extra,
            groups: a.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE ? null : k.bookmark.getGroupNamesSharedByMe(),
          };
        ...
        cb_annotation_add_success: function (a) {
          ...
          window.ga && window.ga("send", "event", "Web site text_view", "highlight", "annotation");
        },
        ...
        cb_ic_add_success: function (a) {
          ...
          a.__annotation_groups && I.find(a.annotationId).addGroups(a.__annotation_groups);
          a.__bookmark_groups && k.bookmark.addGroups(a.__bookmark_groups);
        },
        ...
        editInlineComment: function (a, c) {
          if (k.bookmark.urlId == "") k.bookmark.urlId = qa(window.location.href);
          this.invoke("ic_edit", {
            id: a,
            urlId: k.bookmark.urlId,
            content: c,
        ...
        uploadCacheCheckbf: function (a, c, d) {
          ...
          posturl = x.urls.getUploadMD5Check() + x.utils.string.toQueryString(a) + "&transId=";
        ...
        uploadIndex: function (a, c, d) {
          ...
          posturl = x.urls.getUploadURL() + x.utils.string.toQueryString(a) + "&transId=";
        ...
        cb_user_signIn_success: function (a) {
          if (a.signedIn) {
            ...
            typeof document.addEventListener === "undefined" || typeof c === "undefined" || document.removeEventListener(d, Va, false);
            C.loadBookmark();
          }
        },
        signOut: function () {
      ...
      H = {
        ...
        updateUI: function () {
          ...
          $("#diigolet-tb-btnReadlater b b").removeClass("doing").toggleClass("unread", k.bookmark.unread);
        },
        ...
        create: function () {
          ...
          try {
            var c = (this.j = $(a)
              ...
              .appendTo(document.body)
              .hide());
            $('<div id="diigolet-tray2" class="diigolet" title="Show diigo toolbar"></div>').appendTo(document.body).hide();
          } catch (d) {}
          setTimeout(function () {
          ...
          if (k.launchMode.permalink) {
            ...
            $("a._forwardUserUrl", c)
              .attr({
                href: a ? diigolet.consts.DIIGO_SERVER + "/user/" + a : diigolet.consts.DIIGO_SERVER,
              })
              .text(a || "Diigo");
          ...
          if (!ia() && $.browser.chrome && typeof document.webkitHidden != "undefined") Wa();
          else !ia() && $.browser.mozilla && typeof document.mozHidden != "undefined" && Wa();
        },
        ...
        notify: function (a, c, d) {
          ...
          f.removeClass("success failed info process").find(".diigolet-notice-text").html(a);
          f.children()
    ...
    var U = {
      ...
      create: function () {
        this.j = $(diigolet.consts.HTML_CHROME_PANEL).eq(0).appendTo(document.body);
        var a = this;
        ...
        L =
          {
            ...
            isHighlightElement: function (a) {
              if (
                ...
                cb(a.className, RegExp(this.HIGHLIGHT_ID_CLASS + "([^\\s]+)(?:\\s|$)", "img"), function (d) {
                  c.ids.push(d[1]);
                });
            ...
            isHighlightableNode: function (a) {
              return a.nodeType == 3 || (a.nodeType == 1 && L.tagBlackList.indexOf("," + a.tagName.toLowerCase() + ",") == -1);
            },
            ...
            seek: function (a, c) {
              c = c || 1;
              for (var d = this.html2txt(a), f = this.docTxt, h = 0, i = 0, m = 0; (h = f.indexOf(d, i)) > -1; ) {
                m++;
                i = h + d.length - 1;
                if (m == c) break;
              }
              ...
              for (var o, p = f.length; (o = f[m]), m < p; m++) {
                if (h == o.offset || (h > o.offset && (m + 1 == f.length || h < f[m + 1].offset))) {
                  l = o.node;
                  y = this.findOffset(o.node, d, 1, h - o.offset);
                }
                if (i == o.offset || (i > o.offset && (m + 1 == f.length || i < f[m + 1].offset))) {
                  r = o.node;
            ...
            paint: function (a) {
              ...
              function d(s) {
                var u = $(s.parentNode);
                u.hasClass(L.HIGHLIGHT_CLASS) ? u.addClass(m) : $(s).wrap(c(fa.createElement("em"), i));
              }
              ...
              function f(s, u) {
                $(s)
                  ...
                  .toggleClass(
                    "group",
                    u.inAnyGroups() && l.length > 0 && (B.getCommentsInfo(u.comments) == "onlyGroup" || B.getCommentsInfo(u.comments) == "both")
                  )
              ...
              if (i.paintedSuccessfully) {
                ...
                if (r) {
                  ...
                  if (r.startNode === r.endNode) {
                    if (r.endOffset <= r.startOffset) r.startOffset = r.endOffset - r.txt.length;
                  ...
                  if (i.type == diigolet.consts.ANNOTATION_TYPE_TEXT && $("div." + m).size() <= 0 && a.size() > 0) {
            ...
            adjustIconBg: function (a) {
              ...
              $("div.diigoIcon.diigoHighlightcommented.private." + L.HIGHLIGHT_ID_CLASS + a.id).attr(
                "style",
            ...
            adjustColor: function (a) {
              ...
              $("em." + L.HIGHLIGHT_ID_CLASS + a.id).each(function (d, f) {
                ...
                i = (m + 0.05) / (l + 0.05) > 2.5 ? null : c(i) > 0.5 ? "#000000" : "#FFFFFF";
                i && h.css("color", i);
              });
            },
            unpaint: function (a) {
            ...
            isTextSelected: function () {
              return window.getSelection
                ...
                : $.browser.msie
                ? document.selection.type == "Text" && pa(document.selection.createRange().text).length > 0
                : false;
            },
            getSelection: function () {
              var a = "";
              if (window.getSelection) a = pa(String(window.getSelection()));
              else if ($.browser.msie) a = document.selection.type == "Text" && pa(document.selection.createRange().text);
              return a;
            },
            checkSelection: function () {
              ...
              } else c.html = $.browser.msie ? this.range2html(document.selection.createRange()) : document.getSelection();
              ...
              if ($("<div></div>").html(c.html).find(".diigoHighlight,.diigolet").size() > 0) {
            ...
            html2txt: function (a) {
              a = $("<div></div>").html(this.stripScripts(a)).appendTo(document.body).hide();
              var c = this,
                d = "";
              new aa(
                a[0],
    ...
    var B = {
      ...
      init: function () {
        if ($("#diigolet-dlg-sticky").length === 0) {
          ...
          $("#FN-private-delete").on("click", function (c) {
            ...
            if (a.j.hasClass("onlyPrivate")) {
              a.ann.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && a.ann.unpaint();
              a.hide();
            }
          });
          $("#FN-private-editor")
      ...
      show_: function (a, c, d, f, h) {
        ...
        setTimeout(function () {
          ...
          J(k.myGroups, function (z) {
            $("#FN-group-ul").find('li[data-dgroupname="' + z.name + '"]').length == 0 &&
              y.append(
                A.dom.buildOne(
                  "option",
                  {
      ...
      mergePrivateComments: function (a) {
        for (var c = this.ann, d = c.comments.length, f = [], h = 0; h < d; h++)
          c.comments[h].mode === diigolet.consts.PRIVACY_MODE_PRIVATE && f.push(c.comments[h].id);
        a = {
          annotationId: c.id,
          mode: 2,
          content: a,
      ...
      shareToNewGroup: function () {
        ...
        if (d.match(/^\s*$/)) {
          ...
          if (h.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && !h.saved) {
            ...
            h.saving = true;
            C.addAnnotation(h);
          } else if (h.type == diigolet.consts.ANNOTATION_TYPE_TEXT && !h.saved) {
            h._toAddInlineComment = d;
            h.saving = true;
            C.addAnnotation(h);
      ...
      addPrivateComment: function () {
        ...
        if (!a.match(/^\s*$/)) {
          ...
          if (c.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && (!c.saved || c.onlyInGroup)) {
            c._toAddInlineComment = a;
            c.saving = true;
            C.addAnnotation(c);
          } else if (c.type == diigolet.consts.ANNOTATION_TYPE_TEXT && (!c.saved || c.onlyInGroup)) {
            c._toAddInlineComment = a;
            c.saving = true;
            C.addAnnotation(c);
          } else C.addInlineComment(a);
      ...
      hide: function () {
        ...
        if (this.shown) {
          ...
          var a = this.ann;
          a.activate(false);
          a && a.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && !a.saved && !a.saving && !a.deleted && a.del();
          this.ann = null;
          this.backupContent = "";
        }
      },
      ...
      showActionDropdown: function () {
        ...
        if (d.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE) {
          ...
          d.extra && d.extra.color && d.extra.color.length > 0
            ? K("diigolet-context-" + d.extra.color).toggleClass("colorchecked", true)
    ...
    M(B, {
      ...
      _labelsHtml: function (a) {
        ...
        J(a.groups, function (h) {
          if (c == h.name || c == "_all")
            d += ua('<label class="_#{GROUP_NAME}"><a href="#{GROUP_URL}" class="link">#{GROUP_DISPLAY_NAME}</a>#{DEL}</label>', {
              GROUP_NAME: h.name,
      ...
      ifMoreThanOnePrivateComment: function (a) {
        var c = 0,
          ...
          f;
        if (d === 0) return false;
        for (f = 0; f < d; f++) a[f].mode == diigolet.consts.PRIVACY_MODE_PRIVATE && c++;
      ...
      getGroups: function (a) {
        ...
        a = c.concat();
        for (c = 0; c < a.length; ++c) for (d = c + 1; d < a.length; ++d) JSON.stringify(a[c]) === JSON.stringify(a[d]) && a.splice(d--, 1);
        return (c = a);
      },
      ...
      groupEditor: {
        ...
        submitGroupComment: function () {
          ...
          if (c) {
            ...
            if (d.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && !d.saved) {
              d._toAddInlineComment = c;
              d.saving = true;
              C.addAnnotation(d);
            } else if (d.type == diigolet.consts.ANNOTATION_TYPE_TEXT && !d.saved) {
              d._toAddInlineComment = c;
              d.saving = true;
              C.addAnnotation(d);
        ...
        show: function () {
          ...
          if ((d == "_all" || d == "_public") && (c ? true : true) && (c ? !c.onlyInGroup && c.getComments("_private").length == 0 : true))
            B.NO_PUBLIC_STICKY_NOTES_ALLOWED || a.append('<option value="_public">Public</option>');
          ...
          if (a.find("option").length == 0) B.j.find(".diigoletFNComment").hide();
          else {
    ...
    var R = {
              ...
              J(c, function (m) {
                var l = $(
                  A.dom.buildOne(
                    "div",
                    {
                      id: "diigolet-tag-" + a + "-" + d.escapeTagForElementId(m),
                      class: "tagButton",
                      tag: m,
                    },
                    [m]
                ...
                l.toggleClass("selected", $.inArray(m, h.tags) >= 0).toggleClass("inused", $.inArray(m, i) >= 0);
                l.click(function () {
                  d.toggleTag(m);
                  return false;
                });
        ...
        create: function () {
          ...
          $("#diigolet-dlgBm-btnSaveandmore").click(function (d) {
            ...
            window.open(DIIGO_SERVER + "/toolbar/saved?t=" + d + "&url=" + f + "&tags=" + h);
          });
        ...
        syncData: function (a, c, d, f) {
          ...
          if (a == "data->form") {
            ...
            i.mode = $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").hasClass("checked")
        ...
        updateGroups: function (a) {
          var c = this,
            d = $("#diigo-group").find("select").empty().unbind().removeClass("processing");
          d.append(
            A.dom.buildOne(
              "option",
              {
            ...
            a
              ...
              : d.append(
                  A.dom.buildOne(
                    ...
                    [f.displayName + (k.bookmark.inGroup(f.name) ? " (shared)" : "")]
                  )
                );
          });
          d.append(
        ...
        saveThisLink: function () {
          ...
          if (c) {
            ...
            a.mode = $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").hasClass("checked")
              ? diigolet.consts.PRIVACY_MODE_PRIVATE
              : diigolet.consts.PRIVACY_MODE_PUBLIC;
      ...
      X = (x.Sidebar = {
        ...
        refreshPageComments: function () {
          ...
          $("#d3df-pageCommentList").html(c || diigolet.consts.HTML_3DF_SIDEBAR_NO_COMMENTS);
      ...
      _labelsHtml: function (a) {
        ...
        if (a.isPublic() && (d == "_all" || d == "_public") && a.user == k.user)
          f += '<label class="_public"><span>Public</span>DEL</label>'.replace(
            "DEL",
            Q(h, {
              ONCLICK: Q("diigolet.handle(event, 'sb_del_#{0}', '#{1}')", [c, a.id]),
            })
          );
        ...
        J(a.groups, function (i) {
          if (d == i.name || d == "_all")
            f += Q('<label class="_#{GROUP_NAME}"><a href="#{GROUP_URL}" class="link">#{GROUP_DISPLAY_NAME}</a>#{DEL}</label>', {
              GROUP_NAME: i.name,
              GROUP_DISPLAY_NAME: i.displayName,
              GROUP_URL: x.urls.getGroupURL(i.name),
              DEL: Q(h, {
                ONCLICK: Q("diigolet.handle(event, 'sb_del_#{0}', '#{1}', '#{2}')", [c, a.id, i.name]),
              }),
            });
        });
        return f;
    ...
    var Y = {
        ...
        create: function () {
          ...
          $("#diigolet-csm-search").click(function () {
            ...
            window.open("http://www.diigo.com/search/g?q=" + encodeURIComponent(h) + "&sa=Search");
            return false;
          });
        ...
        show: function () {
          ...
          this.copyClient && this.copyClient.setText(window.getSelection().toString());
        },
        hide: function () {
      ...
      P = {
        ...
        init: function () {
          ...
          K("diigolet-annMenu-share").on("click", function (c) {
            var d = c.pageX + 402 > $(window).width() ? $(window).width() - 404 : c.pageX;
          ...
          $("#diigolet-context-yellow,#diigolet-context-blue,#diigolet-context-green,#diigolet-context-pink").click(function () {
            ...
            K("diigolet-annMenu-currentColor").removeClass("yellow blue green pink").addClass(c);
        ...
        show: function (a, c) {
          if (c.id != this.tempAnnId) {
            ...
            this.j
              .css({
                left: curcorX + 100 > $(window).width() ? $(window).width() - 212 : this.j.hasClass("onlyMy") ? curcorX - 100 : curcorX - 31,
                top: curcorY - 65,
              })
              .show();
            this.shown = true;
            ...
            $(".id_" + c.id).each(function () {
              if ($(this).hasClass("diigoHighlight")) {
                ...
                if ($(this).parent()[0].tagName == "A") f = '<a href="' + $(this).parent().attr("href") + '">' + f + "</a>";
                d += f + " ";
              }
            });
            this.copyText = d;
        ...
        buildMenu: function () {
          ...
          if (a.extra && a.extra.color && a.extra.color.length > 0) {
            K("diigolet-annMenu-currentColor").removeClass("yellow blue green pink").addClass(a.extra.color);
            K("diigolet-context-" + a.extra.color).toggleClass("colorchecked", true);
        ...
        showMenu: function (a, c, d) {
          ...
          if (c.ann)
            if (c.ann.comments.length == 0)
              ...
              f = B.ann != c.ann;
              B.isEditing() || ((f || !B.shown) && !d ? B.scheduleShow(a, c.ann) : B.cancelHide());
            }
        },
        reset: function (a) {
          var c = this;
      ...
      Xa = {
        ...
        create: function () {
          (this.j = $(diigolet.consts.HTML_NOTICE).eq(0).appendTo(document.body).hide()).children().eq(0).siblings().remove();
        },
        destroy: function () {
          this.j.remove();
        },
      ...
      ab = {
        ...
        create: function () {
          this.j = $(
            ...
            .hide();
          this.k = $('<div id="diigo-premium-warning-wrapper"></div>').eq(0).appendTo(document.body.parentNode).hide();
        },
        destroy: function () {
          this.k.remove();
          this.j.remove();
        ...
        show: function (a) {
          ...
          if (c.shown != true) {
            ...
            c.k.css("height", document.body.scrollHeight).css("width", d).show();
            $("#diigo-premium-warning-text p b").text(a);
            a = (window.screen.availHeight - 356) / 2 + document.body.scrollTop;
            this.j.css("left", (window.screen.availWidth - 356) / 2 + "px").css("top", a + "px");
            c.j.show();
            c.shown = true;
    ...
    La.Class = {
      ...
      extend: function (a, c) {
        ...
        for (var f in c) {
          var h = c[f];
          if (d && typeof h == "function" && A.func.argumentNames(h)[0] == "$super") {
            var i = h;
            h = A.extend(
              A.func.wrap(
                (function (m) {
    ...
    var O = La.Class.create({
      ...
      setContacts: function (a, c) {
        ...
        O.contacts = a;
        O.contactListsID = [];
        for (var d = 0; d < O.contacts.length; d++) O.contacts[d].type == "list" && O.contactListsID.push(d);
      },
      showNotice: function () {
        this.tip.attr({
          class: "accNotice",
      ...
      getRecOriItems: function () {
        if (!this.recItemsId || this.recItemsId.length == 0) return null;
          ...
          for (var a = [], c = 0; c < this.recItemsId.length; c++) a.push(O.contacts[this.recItemsId[c]]);
          return a;
        }
      },
    });
    ...
    var Ma = {
      ...
      V = {
        ...
        create: function () {
          var a = this,
            c = (a.j = $(diigolet.consts.HTML_DLG_SHARE).eq(0).appendTo(document.body).hide());
    ...
    V.tabs.email = {
      ...
      composeMessage: function (a) {
        var c = "";
        if (a) c += "<p>" + a + "</p>";
        a = k.pageComments.length > 0 || k.annotations.length > 0 ? Ma.get(k.bookmark.url) || "DIIGO_PERMALINK" : k.bookmark.url;
        a = Q('<p><a class="diigoAnnotatedLink" href="#{1}" title="#{0}">#{0}</a></p>', [k.bookmark.getTitle(), a]);
        c +=
      ...
      trySend: function () {
        ...
        C.shareBookmark(a, function (d) {
          d.code == 1 ? H.notify("Message sent") : H.notify("Message sent failed", undefined, 3);
        });
    ...
    x.AnnotationFormatter = {
      format: function (a) {
        ...
        var c = (a.mode & 2) == 2,
          d = (a.mode & 1) == 1;
        N("[AnnotationFormatter] format mode:", a.mode, "includeOthers", c, "includePrivate", d);
        var f = "";
          ...
          f +=
            ...
            $.map(
              $(k.pageComments).filter(function (h) {
                return (c ? true : h.user == k.user) && (d ? true : h.mode != PRIVACY_MODE_PRIVATE);
              }),
              function (h) {
                return '<li style="line-height:150%;margin-bottom:.6em;">' + A.string.stripTags(h.content) + "</li>";
              }
            ).join("\n") +
            "</ul>";
        f +=
          ...
          $.map(
            ...
            function (h) {
              var i = "";
              if (h.type == diigolet.consts.ANNOTATION_TYPE_TEXT) i = A.string.stripTags(h.content);
              else if (h.type == diigolet.consts.ANNOTATION_TYPE_IMAGE)
                i = A.string.makeTpl('<img src="#{0}" title="#{1}" alt="#{1}">(image)', [h.extra.imageUrl, ""]);
              else if (h.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE)
                i = '<img src="http://www.diigo.com/images/v2/float_note.gif" />(floating sticky note)';
              else if (h.type == diigolet.consts.ANNOTATION_TYPE_FLASH) i = "(flash movie)" + h.content;
              else if (h.type == diigolet.consts.ANNOTATION_TYPE_VIDEO) i = "(video)" + h.content;
              return A.string.makeTpl('<li style="line-height:150%;margin-bottom:.6em;">#{0} #{1} #{2}</li>', [
                i,
                h.groups ? "" : "",
                "<ul>" +
                  $.map(
                    $(h.comments).filter(function (m) {
                      return (c ? true : m.user == k.user) && (d ? true : m.mode != PRIVACY_MODE_PRIVATE);
                    }),
                    function (m) {
                      return (
                        '<li style="line-height:150%;margin-bottom:.6em;">' +
                        A.string.stripTags(m.content) +
                        A.string.makeTpl(' <span style="font-size:11px;color:#aaa">comment by <a href="#{0}">#{1}</a></span>', [
                          x.urls.getUserHomepageURL(m.user),
                          m.realName,
                        ]) +
                        "</li>"
                      );
    ...
    V.tabs.annotatedLink = {
      ...
      show: function () {
        var a = this;
        a.shown = true;
        a.jInput = $("#diigolet-dialog-share-annotatedLink-value").addClass("loading").val("Loading...");
        Ma.get(k.bookmark.url, function (c) {
      ...
      a.fn.Gtooltip = function (f) {
        ...
        return this.each(function () {
          function i() {
            ...
            D = D.indexOf("macintosh") != -1 || D.indexOf("mac os x") != -1 || D.indexOf("linux") != -1 ? true : false;
            switch (m.position) {
              case "bottom":
                G = D ? -9 : -10;
                s = parseInt((q + 2) / 2);
            ...
            if (m.position == "top") z.css("-webkit-transform", "rotate(180deg)");
            else m.position == "bottom" && z.css("-webkit-transform", "rotate(360deg)");
            r.addClass("show");
          }
          var m = a.extend(h, f || {}),
            l = a(this),
    ...
    (function (a) {
      ...
      a.fn._scrollable = function () {
        return this.map(function () {
          ...
          var f = (this.contentWindow || this).document || this.ownerDocument || this;
            ...
            if (f != null) {
              ...
              a.each(i.axis.split(""), function (n, q) {
                ...
                if (z) {
                  ...
                  w[u] += p[s] || 0;
                  if (i.over[s]) w[u] += y[q == "x" ? "width" : "height"]() * i.over[s];
                } else {
                  t = y[s];
                  w[u] = t.slice && t.slice(-1) == "%" ? (parseFloat(t) / 100) * G : t;
                }
                if (i.limit && /^\d+$/.test(w[u])) w[u] = w[u] <= 0 ? 0 : Math.min(w[u], G);
                if (!n && i.queue) {
    ...
    (function (a) {
      ...
      a.scrollmarker.fn.extend({
        init: function () {
          var c = this,
            d = this.place.attr("class").match(/id_([\w]+)/) ? this.place.attr("class").match(/id_([\w]+)/)[0] : "";
          ...
          if (this.place.hasClass("blue")) this.marker.css("background-color", "#0087f7");
          else if (this.place.hasClass("green")) this.marker.css("background-color", "#00a256");
          else this.place.hasClass("pink") ? this.marker.css("background-color", "#ff3399") : this.marker.css("background-color", "#ffb000");
        ...
        position: function () {
          ...
          c = h.indexOf("macintosh") != -1 || h.indexOf("mac os x") != -1 ? (c / d) * f : (c / d) * (f - 34) + 17;
          if (c < 50) c = 50;
          this.marker.css({
            position: "fixed",
            top: c,
        ...
        locate: function () {
          ...
          var c = a(".ss-content");
          c.scrollTo(this.place.position().top + c.scrollTop() - 50, 300, function () {});
    ...
    var Ka = (function () {
      ...
      ub = (function (a) {
        ...
        d.init = function () {
          var f = this;
          f.create();
          f.textarea = document.getElementById("diigolet-highlight-share-textarea");
          ...
          $("#diigolet-highlight-footer").on("click", "a", function (h) {
            if (f.enable) {
              ...
              if (h === "diigolet-highlight-share-copybtn") {
                ...
                window.open(
                  "https://twitter.com/intent/tweet?text=" + encodeURIComponent(f.editor.val()) + " @diigo",
                  "sharer",
        ...
        d.show = function (f, h, i) {
          ...
          m.j.addClass("show");
          m.disable();
          C.makeAnnotatedLinkWithHighlight(k.bookmark.url, 3, f.id, function (l) {
      ...
      za = {
        ...
        init: function () {
          var a = this;
          this.j = $(diigolet.consts.HTML_ANNOTATION_LIST_WINDOW).appendTo($("body")).hide();
          for (var c = k.annotations, d = 0; d < c.length; d++) a.add(c[d]);
          if ($("#diigo-annotationList-box").find(".diigo-annotationList-item").length === 0) {
          ...
          $("#diigo-annotationList-copyall").on("click", function (f) {
            f.preventDefault();
            f = x.AnnotationFormatter.format({
              mode: 1,
              onlyPrivate: true,
            });
            x.Messenger.send({
        ...
        add: function (a) {
          ...
          if (a.onlyInGroup == false && a.user == k.user)
            if (a.type == diigolet.consts.ANNOTATION_TYPE_TEXT) {
              ...
              d.find(".diigo-annotationList-item-content").html(S.html2txt_pretty(a.content));
              ...
              if (a.comments.length) {
                ...
                a.comments.forEach(function (h) {
                  $('<div class="diigo-annotationList-commentItem" data-cid="' + h.id + '">' + h.content + "</div>").appendTo(f);
                });
                d.append(f);
              }
              d.appendTo($("#diigo-annotationList-box"));
              d.find(".diigo-annotationList-item-copy").on("click", function (h) {
                h.stopPropagation();
                var i = $(this).parent().find(".diigo-annotationList-item-content").text();
                $(this)
                  .parent()
                  .parent()
              ...
              d.find(".diigo-annotationList-item-delete").on("click", function (h) {
                h.stopPropagation();
                a.onlyInGroup || a.del();
                J(
              ...
              d.find(".diigo-annotationList-item-content").html(a.comments[0].content);
              d.appendTo($("#diigo-annotationList-box"));
              d.find(".diigo-annotationList-item-copy").on("click", function (h) {
                h.stopPropagation();
                h = $(this).parent().find(".diigo-annotationList-item-content").text();
                x.Messenger.send({
                  name: "copy",
                  details: {
                    text: h,
            ...
            if (f)
              switch (a) {
                ...
                case "updateStickyNote":
                  ...
                  a = c.type;
                  if (a == diigolet.consts.ANNOTATION_TYPE_TEXT) f.find(".diigo-anntationList-commentItem").text(d.content);
                  else a == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && f.find(".diigo-annotationList-item-content").text(d.content);
                  break;
      ...
      sb = {
        j: null,
        init: function () {
          this.j = $('<div class="notify-copy">Copied!</div>').appendTo($("body"));
        },
        show: function () {
          var a = this;
      ...
      tb = {
        ...
        create: function () {
          this.j = $('<div id="diigo-code-clipper"></div>').appendTo("body").hide();
          this.k = $('<div id="diigo-code-clipped">Clipped</div>').appendTo("body").hide();
          this.bindEvents();
        },
        bindEvents: function () {
          var a = this;
          $(document.body).on("mouseenter", "pre", function () {
            ...
            var c = $(this).offset().left,
              ...
              f = $(this).outerWidth(),
              h = $(this).outerHeight();
            d = d + h > fa.body.scrollTop + window.innerHeight ? d + 5 : d + h - 29;
          ...
          $(document.body).on("mouseleave", "pre", function (c) {
            if (!(c.relatedTarget && (c.relatedTarget.id == "diigo-code-clipper" || c.relatedTarget.id == "diigo-code-clipped"))) {
              a.j.hide();
              a.k.hide();
            }
          });
