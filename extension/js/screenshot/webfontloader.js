/* Web Font Loader v1.5.18 - (c) Adobe Systems, Google. License: Apache 2.0 */ (function (window, document, undefined) {
  function aa(a, b, c) {
  ...
  function N(a) {
    ...
    return (
      ...
      b +
      ";" +
      ("font-style:" + c + ";font-weight:" + (a.Z + "00") + ";")
    );
  }
  ...
  O.prototype.start = function () {
    this.oa = n();
    var a = new H(this.o.getName() + ",serif", I(this.o)),
      a = N(a);
    this.t.k.style.cssText = a;
  ...
  function Q(a) {
    var b = a.t.k.offsetWidth,
      c = a.u.k.offsetWidth;
    (b === a.v.serif && c === a.v["sans-serif"]) || (a.m.ga && R(a, b, c))
      ? n() - a.oa >= a.X
        ? a.m.ga && R(a, b, c) && (null === a.ca || a.ca.hasOwnProperty(a.o.getName()))
          ? S(a, a.$)
          : S(a, a.ka)
        : ja(a)
      : S(a, a.$);
  ...
  T.prototype.ia = function (a) {
    ...
    b.F &&
      s(
        ...
        [b.h.e(b.j, a.getName(), I(a).toString(), "loading"), b.h.e(b.j, a.getName(), I(a).toString(), "inactive")]
      );
    K(b, "fontactive", a);
    this.ea = !0;
    la(this);
  ...
  function la(a) {
    0 == --a.S &&
      a.ba &&
      (a.ea ? ((a = a.A), a.F && s(a.q, [a.h.e(a.j, "active")], [a.h.e(a.j, "loading"), a.h.e(a.j, "inactive")]), K(a, "active")) : J(a.A));
  }
