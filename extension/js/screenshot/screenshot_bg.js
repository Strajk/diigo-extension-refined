    ...
    case "update_shortcuts":
      chrome.tabs.getAllInWindow(null, function (tabs) {
        for (var i = 0, len = tabs.length; i < len; i++) {
          var t = tabs[i],
            u = t.url;
          if (!u.match(/https?:\/\/*\/*/gi) || u.match(/https:\/\/chrome.google.com\/extensions/i)) continue;
...
function prepareImage() {
  ...
  var imageOnload = function () {
    ...
    if (type == "visible") {
      ...
      pluginObj.AutoSave(tempDataUrl, tabtitle.replace(/[#$~!@%^&*();'"?><\[\]{}\|,:\/=+-]/g, " "), localStorage["savePath"]);
      ...
      function prepareCanvasH(d, sx, sy, sw, sh, dx, dy, dw, dh, func) {
        ...
        $("#temp_image")
          ...
          .load(function () {
            ...
            if (j < hlen - 1) prepareCanvasH(data[++j], sx, sy, sw, sh, dx, dy, dw, dh);
          });
      }
