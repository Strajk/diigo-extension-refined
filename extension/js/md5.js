function MD5(a) {
  ...
  for (a = 0; a < l.length; a += 16) {
    ...
    v = h;
    w = i;
    f = b(f, g, h, i, l[a + 0], 7, 3614090360);
    ...
    g = b(g, h, i, f, l[a + 15], 22, 1236535329);
    ...
    h = c(h, i, f, g, l[a + 7], 14, 1735328473);
    ...
    g = e(g, h, i, f, l[a + 13], 21, 1309151649);
...
function str2rstr_utf8(a) {
  for (var k = "", b = -1, c, d; ++b < a.length; ) {
    ...
    if (c <= 127) k += String.fromCharCode(c);
    else if (c <= 2047) k += String.fromCharCode(192 | ((c >>> 6) & 31), 128 | (c & 63));
    else if (c <= 65535) k += String.fromCharCode(224 | ((c >>> 12) & 15), 128 | ((c >>> 6) & 63), 128 | (c & 63));
    else if (c <= 2097151) k += String.fromCharCode(240 | ((c >>> 18) & 7), 128 | ((c >>> 12) & 63), 128 | ((c >>> 6) & 63), 128 | (c & 63));
  }
  return k;
}
...
function binl_md5(a, k) {
  ...
  for (var b = 1732584193, c = -271733879, d = -1732584194, e = 271733878, j = 0; j < a.length; j += 16) {
    ...
    b = md5_ff(b, c, d, e, a[j + 8], 7, 1770035416);
    ...
    e = md5_gg(e, b, c, d, a[j + 10], 9, 38016083);
    ...
    d = md5_hh(d, e, b, c, a[j + 11], 16, 1839030562);
    ...
    c = md5_hh(c, d, e, b, a[j + 2], 23, -995338651);
    ...
    b = md5_ii(b, c, d, e, a[j + 4], 6, -145523070);
